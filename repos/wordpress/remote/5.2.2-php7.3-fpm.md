...
### `wordpress:5.2.2-php7.3-fpm` - linux; amd64
...
### `wordpress:5.2.2-php7.3-fpm` - linux; arm64 variant v8
...
### `wordpress:5.2.2-php7.3-fpm` - linux; 386
...
### `wordpress:5.2.2-php7.3-fpm` - linux; ppc64le
