...
### `wordpress:5.2.4-php7.2-apache` - linux; amd64
...
### `wordpress:5.2.4-php7.2-apache` - linux; arm variant v5
...
### `wordpress:5.2.4-php7.2-apache` - linux; arm variant v7
...
### `wordpress:5.2.4-php7.2-apache` - linux; ppc64le
