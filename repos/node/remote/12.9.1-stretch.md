...
### `node:12.9.1-stretch` - linux; amd64
...
### `node:12.9.1-stretch` - linux; arm variant v7
...
### `node:12.9.1-stretch` - linux; arm64 variant v8
...
### `node:12.9.1-stretch` - linux; ppc64le
...
### `node:12.9.1-stretch` - linux; s390x
