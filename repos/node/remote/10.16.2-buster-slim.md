...
```console
$ docker pull node@sha256:fd86a807bca51c0fe1acc223edbab9708029a79a554a02641fce576a6053875e
```
...
### `node:10.16.2-buster-slim` - linux; ppc64le
...
### `node:10.16.2-buster-slim` - linux; s390x
