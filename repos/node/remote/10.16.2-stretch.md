...
```console
$ docker pull node@sha256:d311710b16ad710f979b0a20cb26661d39df5cf5ecd656fb7361ef2d9c7b11c4
```
...
### `node:10.16.2-stretch` - linux; arm64 variant v8
...
### `node:10.16.2-stretch` - linux; ppc64le
...
### `node:10.16.2-stretch` - linux; s390x
