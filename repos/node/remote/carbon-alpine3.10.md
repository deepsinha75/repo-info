## `node:carbon-alpine3.10`

```console
$ docker pull node@sha256:c4a9d1e4aac726bb2fac4a4e810d010a548d5cd62ec4f830b42628caca414d24
```
...
### `node:carbon-alpine3.10` - linux; amd64
...
### `node:carbon-alpine3.10` - linux; arm variant v6
...
### `node:carbon-alpine3.10` - linux; arm variant v7
...
### `node:carbon-alpine3.10` - linux; arm64 variant v8
...
### `node:carbon-alpine3.10` - linux; 386
...
### `node:carbon-alpine3.10` - linux; ppc64le
...
### `node:carbon-alpine3.10` - linux; s390x
