...
```console
$ docker pull node@sha256:aba6a5debf5956e84edad9d4284a060821ec4f64d0c452f0cde6dc60ca8d1bae
```
...
### `node:10.16.2-alpine` - linux; ppc64le
...
### `node:10.16.2-alpine` - linux; s390x
