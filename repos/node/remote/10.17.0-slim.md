...
```console
$ docker pull node@sha256:37c37cc8a47ffa462d0dbdcbd80df88d8557cff3ac6ff6d7ddc081901ccce24e
```
...
### `node:10.17.0-slim` - linux; arm variant v7
...
### `node:10.17.0-slim` - linux; arm64 variant v8
...
### `node:10.17.0-slim` - linux; ppc64le
