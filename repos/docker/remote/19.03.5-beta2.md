...
### `docker:19.03.5-beta2` - linux; amd64
...
### `docker:19.03.5-beta2` - linux; arm variant v6
...
### `docker:19.03.5-beta2` - linux; arm variant v7
...
### `docker:19.03.5-beta2` - linux; arm64 variant v8
