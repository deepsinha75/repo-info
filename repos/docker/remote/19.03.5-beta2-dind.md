...
### `docker:19.03.5-beta2-dind` - linux; amd64
...
### `docker:19.03.5-beta2-dind` - linux; arm variant v6
...
### `docker:19.03.5-beta2-dind` - linux; arm variant v7
...
### `docker:19.03.5-beta2-dind` - linux; arm64 variant v8
