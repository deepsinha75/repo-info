...
```console
$ docker pull nats-streaming@sha256:393995b43fe1ef884a24c3b6a548968adbd972104fce2351458e68a6d57238c1
```
...
```console
$ docker pull nats-streaming@sha256:9efeefb7e2d9ae089fc554c162baaa864f00538f8ed8a935bb797269a97d8d8e
```
...
### `nats-streaming:0.16.2-linux` - linux; arm64 variant v8
...
### `nats-streaming:0.16.2-windowsservercore` - windows version 10.0.14393.3204; amd64
...
```console
$ docker pull nats-streaming@sha256:a97647bdaf10984b500b7629c1d269eb62616b0736824d55c9d48ca19eae3f19
```
