...
```console
$ docker pull tomcat@sha256:81586d88f7d5a250948c52d208ca00d858cdc0952455df2926629fd8188fe39b
```
...
```console
$ docker pull tomcat@sha256:20fdff959fbbe78bdcd3ef281918b24f44fdd9df976819a482251462bae2a84a
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **145.0 MB (145002161 bytes)**  
