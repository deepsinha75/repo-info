...
```console
$ docker pull tomcat@sha256:c26763907afe4a94a8c99ff7937caa1c33dbcbcb7e08ad66ec392b4838b5032d
```
...
```console
$ docker pull tomcat@sha256:01afc536add432f86c4cdef73075628f5b053f58fa6cba40e063e0de17dd73ee
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **229.8 MB (229786251 bytes)**  
