...
```console
$ docker pull haproxy@sha256:5c8292f15df2a43afad8b625e5e4038f5838f4107b28170539800e3caf3e0225
```
...
```console
$ docker pull haproxy@sha256:c0d26a6f14809e77a365ffb0fb395c35e43f4b5fcba15eaa9dfbeca050eaa532
```
