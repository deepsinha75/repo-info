...
- Created: `2019-08-14T03:21:52.807218144Z`
...
### `dpkg` source package: `exim4=4.89-2+deb9u5`
...
```console
$ apt-get source -qq --print-uris exim4=4.89-2+deb9u5
'http://deb.debian.org/debian/pool/main/e/exim4/exim4_4.89-2+deb9u5.dsc' exim4_4.89-2+deb9u5.dsc 2818 SHA256:2a2e9ddd0859a3f630b18311e551c32caa9c750538b8cce184891feb6b88969d
...
'http://deb.debian.org/debian/pool/main/e/exim4/exim4_4.89-2+deb9u5.debian.tar.xz' exim4_4.89-2+deb9u5.debian.tar.xz 453336 SHA256:deb9fa5134c48ae7adc71ca5a30ea1b419cc254170ec5a56b9d36977ddb98652
```

Other potentially useful URLs:

- https://sources.debian.net/src/exim4/4.89-2+deb9u5/ (for browsing the source)
- https://sources.debian.net/src/exim4/4.89-2+deb9u5/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/exim4/4.89-2+deb9u5/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `postgresql-11=11.5-1.pgdg90+1`

Binary Packages:

- `libpq5:amd64=11.5-1.pgdg90+1`
- `postgresql-11=11.5-1.pgdg90+1`
- `postgresql-client-11=11.5-1.pgdg90+1`
...
```console
$ apt-get source -qq --print-uris postgresql-11=11.5-1.pgdg90+1
'http://apt.postgresql.org/pub/repos/apt/pool/main/p/postgresql-11/postgresql-11_11.5-1.pgdg90+1.dsc' postgresql-11_11.5-1.pgdg90+1.dsc 2663 SHA256:c67ccc23c95bfa88268bd28758ce7107bea1dc7390de3a33cfe0ea99fd762a61
'http://apt.postgresql.org/pub/repos/apt/pool/main/p/postgresql-11/postgresql-11_11.5.orig.tar.bz2' postgresql-11_11.5.orig.tar.bz2 19773087 SHA256:7fdf23060bfc715144cbf2696cf05b0fa284ad3eb21f0c378591c6bca99ad180
'http://apt.postgresql.org/pub/repos/apt/pool/main/p/postgresql-11/postgresql-11_11.5-1.pgdg90+1.debian.tar.xz' postgresql-11_11.5-1.pgdg90+1.debian.tar.xz 25380 SHA256:3df75bce53002fa08b44f973fe5febf62dfeac76d38417678c28f703692797c5
```

### `dpkg` source package: `postgresql-common=204.pgdg90+1`

Binary Packages:

- `postgresql-client-common=204.pgdg90+1`
- `postgresql-common=204.pgdg90+1`
...
```console
$ apt-get source -qq --print-uris postgresql-common=204.pgdg90+1
'http://apt.postgresql.org/pub/repos/apt/pool/main/p/postgresql-common/postgresql-common_204.pgdg90+1.dsc' postgresql-common_204.pgdg90+1.dsc 1577 SHA256:3c93707c2cfcc13fca5386677da0f3f816d66c14f847a691829291eaf22b5a8c
'http://apt.postgresql.org/pub/repos/apt/pool/main/p/postgresql-common/postgresql-common_204.pgdg90+1.tar.xz' postgresql-common_204.pgdg90+1.tar.xz 215696 SHA256:fd58de6e8dc195283d817d7ac3461bac3162b8bea3c0ffa59265a059030dbe5c
```
