...
```console
$ docker pull drupal@sha256:982c83b6ee86b7fa18fb039b25486daa1b078a77015b3f2a40ea6084ef2e22df
```
...
### `drupal:8.7.6-fpm` - linux; arm variant v5
...
### `drupal:8.7.6-fpm` - linux; arm variant v7
...
### `drupal:8.7.6-fpm` - linux; ppc64le
