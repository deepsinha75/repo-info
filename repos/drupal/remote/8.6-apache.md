...
```console
$ docker pull drupal@sha256:01261f78204c93358e03bf43d4cc83e0621b41f876005b70d91fd018ba5351f2
```
...
```console
$ docker pull drupal@sha256:95f519f1442a07e110c6872f2dbebc85f2e04b3146388f862f2ba30856c68bf0
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **153.8 MB (153783534 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:10b1e07a7ef9849b378b764ac51b2d849ae1a2b4f57b73e817ed5badae3e2e13`
...
# Sat, 05 Oct 2019 05:37:20 GMT
WORKDIR /var/www/html
# Sat, 05 Oct 2019 05:41:51 GMT
ENV DRUPAL_VERSION=8.6.17
# Sat, 05 Oct 2019 05:41:52 GMT
ENV DRUPAL_MD5=9018a2d11381aeb0e269ca696fed9ac5
# Sat, 05 Oct 2019 05:42:06 GMT
...
-	Layers:
	...
	-	`sha256:658398927ac0c2d9570ced0232f6c98915b6bc254e4eb8654c20082a71484a82`  
		...
		Size: 339.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f7e9fdc84ee21bd457cae7fe15e31d02970b2f2d30aae8fd6d26d548f72682ca`  
		Last Modified: Sat, 05 Oct 2019 05:50:52 GMT  
...
```console
$ docker pull drupal@sha256:9c157fede8c024cea640c411923154030435c9fb30d97574c34abd151ee19e45
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **140.9 MB (140905981 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:778e4d5b6c5623713cb8795ae292301bd14f3942b27e853090f49a5cd63c4708`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Sat, 05 Oct 2019 01:38:41 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype-dir=/usr 		--with-jpeg-dir=/usr 		--with-png-dir=/usr 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Sat, 05 Oct 2019 01:38:43 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 05 Oct 2019 01:38:44 GMT
WORKDIR /var/www/html
# Sat, 05 Oct 2019 01:41:29 GMT
ENV DRUPAL_VERSION=8.6.17
# Sat, 05 Oct 2019 01:41:30 GMT
ENV DRUPAL_MD5=9018a2d11381aeb0e269ca696fed9ac5
# Sat, 05 Oct 2019 01:41:46 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:db272dbd3060b230b4d1eee6c402a2a6bb3acbdf2e3e30e2dd0dfe7cd3be5cb4`  
		...
		Size: 905.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6ef1ec562652030087524df76809b769dabc0ab658eb87df7e7d79b2b9dcbe6f`  
		Last Modified: Sat, 05 Oct 2019 01:46:37 GMT  
		Size: 1.5 MB (1496024 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8384f307b3dcf1cdf820e6283bf21f705b23cd31031d22df5cbe8e00e0fe5dfc`  
		Last Modified: Sat, 05 Oct 2019 01:46:36 GMT  
		Size: 339.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:65634a8bd30a05582f926a80656edaccddb45190a52c0ae57e4f4354d3a76c82`  
		Last Modified: Sat, 05 Oct 2019 01:47:46 GMT  
...
```console
$ docker pull drupal@sha256:a162cead06c8958a52084878cd6d8904996e95e57bd749882bbfeea4e6b4d36b
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **133.8 MB (133772423 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bc1aef93a591a74cf564d3fe5491c11c33a3d1c0c0796898ea58b53bfa20da1a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
WORKDIR /var/www/html
# Sat, 05 Oct 2019 01:56:11 GMT
ENV DRUPAL_VERSION=8.6.17
# Sat, 05 Oct 2019 01:56:12 GMT
ENV DRUPAL_MD5=9018a2d11381aeb0e269ca696fed9ac5
# Sat, 05 Oct 2019 01:56:28 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:c7f2477915f8609c65dcf5954c22de966721571f207a806ee34db4f3557c34c7`  
		...
		Size: 339.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2666279db7559844f94a19c683bacb8b6c2f4ce6759a5581cbbd5ff08c6fc525`  
		Last Modified: Sat, 05 Oct 2019 02:05:07 GMT  
...
```console
$ docker pull drupal@sha256:e6f6c1446dd033e267f735b50ce4996b486d368eeb773ff7ef75f162fbe8e295
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **140.0 MB (140046308 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:20fb975b98ddfda69e681236f55c14040657cc77680fbd708ce84bc80e65f07d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
WORKDIR /var/www/html
# Sat, 05 Oct 2019 03:55:55 GMT
ENV DRUPAL_VERSION=8.6.17
# Sat, 05 Oct 2019 03:55:55 GMT
ENV DRUPAL_MD5=9018a2d11381aeb0e269ca696fed9ac5
# Sat, 05 Oct 2019 03:56:06 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:d43980a5fd9d2a82af384316b221062e15fc0edd37762922268efde9ac9a7a27`  
		...
		Size: 339.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7ace6a740429d1f26513ea6463ee2c6984599ae00b0b194974ba0bc41d5f7d5f`  
		Last Modified: Sat, 05 Oct 2019 04:03:54 GMT  
...
```console
$ docker pull drupal@sha256:808319c2c67af412f2e66dcee908324f17b0f97eda3ae86bd60ffa0982b8f20d
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **159.3 MB (159301321 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9c5ce3a62da25958263a0cbd6f2a2c150885de504d229559d7a94c3dec14aa23`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:ce57c04b70896f77cc11eb2766417d8a1240fcffe5bba92179ec78c458844110 in /usr/local/bin/ 
# Fri, 04 Oct 2019 23:34:21 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	sed -e 's/stretch/buster/g' /etc/apt/sources.list > /etc/apt/sources.list.d/buster.list; 	{ 		echo 'Package: *'; 		echo 'Pin: release n=buster'; 		echo 'Pin-Priority: -10'; 		echo; 		echo 'Package: libargon2*'; 		echo 'Pin: release n=buster'; 		echo 'Pin-Priority: 990'; 	} > /etc/apt/preferences.d/argon2-buster; 	apt-get update; 	apt-get install -y --no-install-recommends 		libargon2-dev 		libcurl4-openssl-dev 		libedit-dev 		libsodium-dev 		libsqlite3-dev 		libssl-dev 		libxml2-dev 		zlib1g-dev 		${PHP_EXTRA_BUILD_DEPS:-} 	; 	rm -rf /var/lib/apt/lists/*; 		export 		CFLAGS="$PHP_CFLAGS" 		CPPFLAGS="$PHP_CPPFLAGS" 		LDFLAGS="$PHP_LDFLAGS" 	; 	docker-php-source extract; 	cd /usr/src/php; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	if [ ! -d /usr/include/curl ]; then 		ln -sT "/usr/include/$debMultiarch/curl" /usr/local/include/curl; 	fi; 	./configure 		--build="$gnuArch" 		--with-config-file-path="$PHP_INI_DIR" 		--with-config-file-scan-dir="$PHP_INI_DIR/conf.d" 				--enable-option-checking=fatal 				--with-mhash 				--enable-ftp 		--enable-mbstring 		--enable-mysqlnd 		--with-password-argon2 		--with-sodium=shared 		--with-pdo-sqlite=/usr 		--with-sqlite3=/usr 				--with-curl 		--with-libedit 		--with-openssl 		--with-zlib 				$(test "$gnuArch" = 's390x-linux-gnu' && echo '--without-pcre-jit') 		--with-libdir="lib/$debMultiarch" 				${PHP_EXTRA_CONFIGURE_ARGS:-} 	; 	make -j "$(nproc)"; 	find -type f -name '*.a' -delete; 	make install; 	find /usr/local/bin /usr/local/sbin -type f -executable -exec strip --strip-all '{}' + || true; 	make clean; 		cp -v php.ini-* "$PHP_INI_DIR/"; 		cd /; 	docker-php-source delete; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 	find /usr/local -type f -executable -exec ldd '{}' ';' 		| awk '/=>/ { print $(NF-1) }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -r apt-mark manual 	; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 		pecl update-channels; 	rm -rf /tmp/pear ~/.pearrc; 	php --version
# Fri, 04 Oct 2019 23:34:21 GMT
COPY multi:99e4ad617c6193834e78d12470f6dde09f70f4d40463009c5724954902e60676 in /usr/local/bin/ 
# Fri, 04 Oct 2019 23:34:22 GMT
RUN docker-php-ext-enable sodium
# Fri, 04 Oct 2019 23:34:22 GMT
ENTRYPOINT ["docker-php-entrypoint"]
# Fri, 04 Oct 2019 23:34:23 GMT
STOPSIGNAL WINCH
# Fri, 04 Oct 2019 23:34:23 GMT
COPY file:e3123fcb6566efa979f945bfac1c94c854a559d7b82723e42118882a8ac4de66 in /usr/local/bin/ 
# Fri, 04 Oct 2019 23:34:23 GMT
...
# Fri, 04 Oct 2019 23:34:23 GMT
CMD ["apache2-foreground"]
# Sat, 05 Oct 2019 06:40:41 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype-dir=/usr 		--with-jpeg-dir=/usr 		--with-png-dir=/usr 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Sat, 05 Oct 2019 06:40:42 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 05 Oct 2019 06:40:42 GMT
WORKDIR /var/www/html
# Sat, 05 Oct 2019 06:43:43 GMT
ENV DRUPAL_VERSION=8.6.17
# Sat, 05 Oct 2019 06:43:43 GMT
ENV DRUPAL_MD5=9018a2d11381aeb0e269ca696fed9ac5
# Sat, 05 Oct 2019 06:43:52 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:4cb88efbbcdd32d82d000e0d0f732e812ed1f55df021f7c2c367094a60cada2d`  
		...
		Size: 502.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a937f89b012da9fbec813f08fc652fe70718a6fc9ff273c1c181be1ef86f9dbd`  
		Last Modified: Sat, 05 Oct 2019 04:57:43 GMT  
		Size: 15.7 MB (15710040 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:00ebaf0c254fef776d080e36f9f1defc3c7d5cd9ca476d07f88c0ac868b2e96e`  
		Last Modified: Sat, 05 Oct 2019 04:57:39 GMT  
		Size: 2.2 KB (2224 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f165034d30fa7c5d02faa376652dc4bbe892ea036fe57e534bc7785e66b3e26b`  
		Last Modified: Sat, 05 Oct 2019 04:57:39 GMT  
		Size: 256.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:538632797adc8cee4671e4cf0c115f187526cce48cba20525fb93db24f6099e2`  
		Last Modified: Sat, 05 Oct 2019 04:57:38 GMT  
		Size: 902.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ecc69fc98decb0f836de79ba92b0f5984b20af6c7e6a6bc16396408994f38387`  
		Last Modified: Sat, 05 Oct 2019 06:48:55 GMT  
		Size: 1.7 MB (1664955 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4d060aefd75c091202f1186c4e5411dcc89b111c27b7665b964cead55b4ec845`  
		Last Modified: Sat, 05 Oct 2019 06:48:54 GMT  
		Size: 337.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c49158afffc87bc095f8705b4ea13323650295ace5d74974c7ac6cbfaafeed07`  
		Last Modified: Sat, 05 Oct 2019 06:49:55 GMT  
...
```console
$ docker pull drupal@sha256:3b22860a68c58bfc7a983dff9102852edb7f8e68a6139d2bfdefe93d66092b7e
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **148.1 MB (148114201 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:697ff3d7dac9f422f70d2ada73b96e76496fe19169ce33e48c1359be4eb90a16`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Sat, 05 Oct 2019 03:45:41 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype-dir=/usr 		--with-jpeg-dir=/usr 		--with-png-dir=/usr 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Sat, 05 Oct 2019 03:45:46 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 05 Oct 2019 03:45:48 GMT
WORKDIR /var/www/html
# Sat, 05 Oct 2019 03:49:35 GMT
ENV DRUPAL_VERSION=8.6.17
# Sat, 05 Oct 2019 03:49:37 GMT
ENV DRUPAL_MD5=9018a2d11381aeb0e269ca696fed9ac5
# Sat, 05 Oct 2019 03:50:04 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:f673a212857a77ab8089ded151dfce32a39613d05d8b54257a273b1dda4082d3`  
		...
		Size: 903.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c69bab8d524675158e8081ae3fd9c318bd2b8f667f0fc61357c730b42bee951b`  
		Last Modified: Sat, 05 Oct 2019 03:57:16 GMT  
		Size: 1.6 MB (1595058 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:54eac50c9fab4cd997f8a35ca9ad3ae5f0014b3a9843de70b20854784239b8f5`  
		Last Modified: Sat, 05 Oct 2019 03:57:15 GMT  
		Size: 339.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:78569c276e53a342cb26973fa05a22dac128c4fbd13125df5747ddb8087a237f`  
		Last Modified: Sat, 05 Oct 2019 03:59:46 GMT  
