...
### `rabbitmq:3.7.17-beta.1-alpine` - linux; amd64
...
### `rabbitmq:3.7.17-beta.1-alpine` - linux; arm variant v6
...
### `rabbitmq:3.7.17-beta.1-alpine` - linux; arm64 variant v8
...
### `rabbitmq:3.7.17-beta.1-alpine` - linux; 386
...
### `rabbitmq:3.7.17-beta.1-alpine` - linux; ppc64le
...
### `rabbitmq:3.7.17-beta.1-alpine` - linux; s390x
