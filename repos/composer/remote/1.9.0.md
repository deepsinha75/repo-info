...
```console
$ docker pull composer@sha256:7ec567b0369cdb8e2a5553e53521415e13be598d6b62dd9fac45331bfe51f90c
```
...
```console
$ docker pull composer@sha256:f20f30bd2bf51b65ea38287ebf273511caa055d4867c377cb720aa25926a7755
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **62.1 MB (62145652 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8d227a45700194014e37af2096fa359b22870b270347b9f067dd0983bad3ffb5`
-	Entrypoint: `["\/bin\/sh","\/docker-entrypoint.sh"]`
-	Default Command: `["composer"]`
...
# Tue, 22 Oct 2019 01:38:47 GMT
ENV COMPOSER_VERSION=1.9.0
# Tue, 22 Oct 2019 01:38:48 GMT
RUN set -eux;   curl --silent --fail --location --retry 3 --output /tmp/installer.php --url https://raw.githubusercontent.com/composer/getcomposer.org/cb19f2aa3aeaa2006c0cd69a7ef011eb31463067/web/installer;   php -r "     \$signature = '48e3236262b34d30969dca3c37281b3b4bbe3221bda826ac6a9a62d6444cdb0dcd0615698a5cbe587c3f0fe57a54d8f5';     \$hash = hash('sha384', file_get_contents('/tmp/installer.php'));     if (!hash_equals(\$signature, \$hash)) {       unlink('/tmp/installer.php');       echo 'Integrity check failed, installer is either corrupt or worse.' . PHP_EOL;       exit(1);     }";   php /tmp/installer.php --no-ansi --install-dir=/usr/bin --filename=composer --version=${COMPOSER_VERSION};   composer --ansi --version --no-interaction;   rm -f /tmp/installer.php;   find /tmp -type d -exec chmod -v 1777 {} +
# Tue, 22 Oct 2019 01:38:48 GMT
COPY file:098af1c9d6ed00c2f357827391da1b2b0978915db35f033349301c7cbe78010d in /docker-entrypoint.sh 
# Tue, 22 Oct 2019 01:38:49 GMT
WORKDIR /app
# Tue, 22 Oct 2019 01:38:49 GMT
ENTRYPOINT ["/bin/sh" "/docker-entrypoint.sh"]
# Tue, 22 Oct 2019 01:38:49 GMT
...
-	Layers:
	...
	-	`sha256:732dd3ad4743daaa8da6d0aea0d217305cd1a165488eb5b1de71af6943c6ca48`  
		...
		Size: 255.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:752245aa901a6b400a00b245de4b4eadad56cfefb9df077364b1fbc886520d5e`  
		Last Modified: Tue, 22 Oct 2019 01:39:04 GMT  
		Size: 497.4 KB (497427 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e74826ba87281bb16ed6e810897096e6882c1b8e35d3bd51da9ad7e0c87d0404`  
		Last Modified: Tue, 22 Oct 2019 01:39:04 GMT  
		Size: 555.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:293382c6d9295d157c78da8dc589777ef787ebe7b9b4d8a55931e4897f7d0fb2`  
		Last Modified: Tue, 22 Oct 2019 01:39:04 GMT  
		Size: 92.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
