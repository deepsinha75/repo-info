...
-	[`clojure:openjdk-11-tools-deps-1.10.1.469`](#clojureopenjdk-11-tools-deps-1101469)
-	[`clojure:openjdk-11-tools-deps-1.10.1.469-slim-buster`](#clojureopenjdk-11-tools-deps-1101469-slim-buster)
-	[`clojure:openjdk-11-tools-deps-1.10.1.469-stretch`](#clojureopenjdk-11-tools-deps-1101469-stretch)
...
-	[`clojure:openjdk-13-tools-deps-1.10.1.469`](#clojureopenjdk-13-tools-deps-1101469)
-	[`clojure:openjdk-13-tools-deps-1.10.1.469-buster`](#clojureopenjdk-13-tools-deps-1101469-buster)
-	[`clojure:openjdk-13-tools-deps-1.10.1.469-slim-buster`](#clojureopenjdk-13-tools-deps-1101469-slim-buster)
...
-	[`clojure:openjdk-14-tools-deps-1.10.1.469`](#clojureopenjdk-14-tools-deps-1101469)
-	[`clojure:openjdk-14-tools-deps-1.10.1.469-alpine`](#clojureopenjdk-14-tools-deps-1101469-alpine)
-	[`clojure:openjdk-14-tools-deps-1.10.1.469-buster`](#clojureopenjdk-14-tools-deps-1101469-buster)
-	[`clojure:openjdk-14-tools-deps-1.10.1.469-slim-buster`](#clojureopenjdk-14-tools-deps-1101469-slim-buster)
...
-	[`clojure:openjdk-8-tools-deps-1.10.1.469`](#clojureopenjdk-8-tools-deps-1101469)
-	[`clojure:openjdk-8-tools-deps-1.10.1.469-slim-buster`](#clojureopenjdk-8-tools-deps-1101469-slim-buster)
-	[`clojure:openjdk-8-tools-deps-1.10.1.469-stretch`](#clojureopenjdk-8-tools-deps-1101469-stretch)
...
-	[`clojure:tools-deps-1.10.1.469`](#clojuretools-deps-1101469)
-	[`clojure:tools-deps-1.10.1.469-slim-buster`](#clojuretools-deps-1101469-slim-buster)
-	[`clojure:tools-deps-1.10.1.469-stretch`](#clojuretools-deps-1101469-stretch)
...
```console
$ docker pull clojure@sha256:eefccd7288858c648c28ad3912c4e4d0c3ba1aca99c77ff58d2c3c140a7a4fe3
```
...
```console
$ docker pull clojure@sha256:8ea162f932d0347796945dcac92a66004cbed931e32d1ef7805f0f9457c4056a
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **244.5 MB (244463712 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:77a717f326cc325081977c93914c9c9179d752a5012ea0101df29ed856c4304e`
-	Default Command: `["lein","repl"]`
...
# Sat, 14 Sep 2019 00:42:26 GMT
CMD ["jshell"]
# Thu, 03 Oct 2019 22:40:03 GMT
ENV LEIN_VERSION=2.9.1
# Thu, 03 Oct 2019 22:40:03 GMT
ENV LEIN_INSTALL=/usr/local/bin/
# Thu, 03 Oct 2019 22:40:04 GMT
WORKDIR /tmp
# Thu, 03 Oct 2019 22:40:23 GMT
RUN apt-get update && apt-get install -y gnupg wget && rm -rf /var/lib/apt/lists/* && mkdir -p $LEIN_INSTALL && wget -q https://raw.githubusercontent.com/technomancy/leiningen/$LEIN_VERSION/bin/lein-pkg && echo "Comparing lein-pkg checksum ..." && sha1sum lein-pkg && echo "93be2c23ab4ff2fc4fcf531d7510ca4069b8d24a *lein-pkg" | sha1sum -c - && mv lein-pkg $LEIN_INSTALL/lein && chmod 0755 $LEIN_INSTALL/lein && wget -q https://github.com/technomancy/leiningen/releases/download/$LEIN_VERSION/leiningen-$LEIN_VERSION-standalone.zip && wget -q https://github.com/technomancy/leiningen/releases/download/$LEIN_VERSION/leiningen-$LEIN_VERSION-standalone.zip.asc && gpg --batch --keyserver pool.sks-keyservers.net --recv-key 2B72BF956E23DE5E830D50F6002AF007D1A7CC18 && echo "Verifying Jar file signature ..." && gpg --verify leiningen-$LEIN_VERSION-standalone.zip.asc && rm leiningen-$LEIN_VERSION-standalone.zip.asc && mkdir -p /usr/share/java && mv leiningen-$LEIN_VERSION-standalone.zip /usr/share/java/leiningen-$LEIN_VERSION-standalone.jar && apt-get remove -y --purge gnupg wget
# Thu, 03 Oct 2019 22:40:23 GMT
ENV PATH=/usr/local/openjdk-11/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/local/bin/
# Thu, 03 Oct 2019 22:40:24 GMT
ENV LEIN_ROOT=1
# Thu, 03 Oct 2019 22:40:33 GMT
RUN echo '(defproject dummy "" :dependencies [[org.clojure/clojure "1.10.1"]])' > project.clj   && lein deps && rm project.clj
# Thu, 03 Oct 2019 22:40:34 GMT
CMD ["lein" "repl"]
```
...
-	Layers:
	...
	-	`sha256:837c11e05d45afd78bcd2eba1726a9f743947460a2e2f6d3fe9c0cf68e4b3eef`  
		...
		Size: 193.6 MB (193582407 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6d570f8e9e9984bb7f228ac51863c8db1bde220fde23b7655a224c9fa8763221`  
		Last Modified: Thu, 03 Oct 2019 22:45:00 GMT  
		Size: 17.8 MB (17765788 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c5f8c8ac70b098e9ef4631f384b5790195345ddf2c0e005c7dcb64a14de28ed6`  
		Last Modified: Thu, 03 Oct 2019 22:44:58 GMT  
...
```console
$ docker pull clojure@sha256:157c027df3027e0c469f0b7686048d9daf041999ba8834c582dc480a21d22f97
```
...
```console
$ docker pull clojure@sha256:97d294934df903b265361d6b7241fb0698ac3e12925983a16b8c2bacf686b257
```
...
```console
$ docker pull clojure@sha256:735dc5437829bcc76e467beaa7fd8617d43ac610101617b8cb325ca40d7658ae
```
...
```console
$ docker pull clojure@sha256:a13937dae9132145f75b0276759ad98fbe6e33da901ba793fc3c0ba6012342ae
```
...
```console
$ docker pull clojure@sha256:09bb891c9f9c07552d911fc1bdbb50438df707e334a6ff06999ce01f3fa8df73
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **327.1 MB (327053680 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5a229dc1b20ce4bc0585fef7317078c70ee93952c9bedf59cd0d48b80c0e204b`
-	Default Command: `["sh","-c","sleep 1 && exec clj"]`
...
# Sat, 14 Sep 2019 00:41:29 GMT
CMD ["jshell"]
# Thu, 03 Oct 2019 22:43:16 GMT
ENV CLOJURE_VERSION=1.10.1.469
# Thu, 03 Oct 2019 22:43:17 GMT
WORKDIR /tmp
# Thu, 03 Oct 2019 22:43:26 GMT
RUN wget https://download.clojure.org/install/linux-install-$CLOJURE_VERSION.sh && chmod +x linux-install-$CLOJURE_VERSION.sh && ./linux-install-$CLOJURE_VERSION.sh && clojure -e "(clojure-version)"
# Thu, 03 Oct 2019 22:43:27 GMT
CMD ["sh" "-c" "sleep 1 && exec clj"]
```
...
-	Layers:
	...
	-	`sha256:a9f9e058f7fa18444638ae56ff9f63fa7e550f807fcc946a04887993b1f195c7`  
		...
		Size: 193.3 MB (193325641 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6a26dd9c3a32c72ea9e1033f27311bc6b77d459ddc21b153c03d27ae047c4101`  
		Last Modified: Thu, 03 Oct 2019 22:45:59 GMT  
		Size: 23.9 MB (23892395 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
### `clojure:openjdk-11-tools-deps-1.10.1.469` - linux; amd64
...
### `clojure:openjdk-11-tools-deps-1.10.1.469` - linux; arm64 variant v8
...
```console
$ docker pull clojure@sha256:5ac6a0323e76e2e8e89603ba9f46c8d20c29b937dffbc97bc4fdcd4e5655491d
```
...
```console
$ docker pull clojure@sha256:f6406b347245a025da9de4c2f24fe41522f7c2aeb510f110049c345ded66376b
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **272.9 MB (272935720 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:97308693a1104e870a6dfa267a847edca33a10ae2cc754806a166f1dbf6a0661`
-	Default Command: `["sh","-c","sleep 1 && exec clj"]`
...
# Sat, 14 Sep 2019 00:23:18 GMT
CMD ["jshell"]
# Thu, 03 Oct 2019 22:25:55 GMT
ENV CLOJURE_VERSION=1.10.1.469
# Thu, 03 Oct 2019 22:25:55 GMT
WORKDIR /tmp
# Thu, 03 Oct 2019 22:26:13 GMT
...
-	Layers:
	...
	-	`sha256:f430704e961738b7d7d861f18a7f3b49bbc44482f5266ee6a5f61bfed09742ee`  
		...
		Size: 196.0 MB (195975702 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f20152b298744ffc65a51f6d94db90c7a236b41ca78ef98e1ea660162a37513f`  
		Last Modified: Thu, 03 Oct 2019 22:36:52 GMT  
		Size: 46.6 MB (46618689 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `clojure:openjdk-11-tools-deps-1.10.1.469-slim-buster` - linux; arm64 variant v8

```console
$ docker pull clojure@sha256:1da04b8818282a39c54a4c070a6ebe6d662139c3d50ebe85e1636be6ba96ca1d
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **268.6 MB (268643337 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:99c19b50960b158b41244b4fbf22dbede164c84b56fa7256b68c53a07e18b14a`
-	Default Command: `["sh","-c","sleep 1 && exec clj"]`
...
# Sat, 14 Sep 2019 00:42:26 GMT
CMD ["jshell"]
# Thu, 03 Oct 2019 22:43:32 GMT
ENV CLOJURE_VERSION=1.10.1.469
# Thu, 03 Oct 2019 22:43:33 GMT
WORKDIR /tmp
# Thu, 03 Oct 2019 22:44:09 GMT
RUN apt-get update && apt-get install -y curl rlwrap wget && rm -rf /var/lib/apt/lists/* && wget https://download.clojure.org/install/linux-install-$CLOJURE_VERSION.sh && chmod +x linux-install-$CLOJURE_VERSION.sh && ./linux-install-$CLOJURE_VERSION.sh && clojure -e "(clojure-version)" && apt-get remove -y --purge curl wget
# Thu, 03 Oct 2019 22:44:11 GMT
CMD ["sh" "-c" "sleep 1 && exec clj"]
```
...
-	Layers:
	...
	-	`sha256:837c11e05d45afd78bcd2eba1726a9f743947460a2e2f6d3fe9c0cf68e4b3eef`  
		...
		Size: 193.6 MB (193582407 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:70a6e5a0ff603378c48d9621ba792b10a9e527080bd0b87deb32235c94e5d55d`  
		Last Modified: Thu, 03 Oct 2019 22:46:25 GMT  
		Size: 46.1 MB (46113707 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

## `clojure:openjdk-11-tools-deps-1.10.1.469-stretch`
...
### `clojure:openjdk-11-tools-deps-1.10.1.469-stretch` - linux; amd64
...
### `clojure:openjdk-11-tools-deps-1.10.1.469-stretch` - linux; arm64 variant v8
...
```console
$ docker pull clojure@sha256:c304d5034dab6bdb159ba35ced33ec3d0ecfbbd880a320efe7fce87ebee4fbd4
```
...
```console
$ docker pull clojure@sha256:f44933cf558f71203abf1f331a3092d1a1c4d3c633b29ca190c04e814cd22b0a
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **348.1 MB (348128004 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e67dc6cead7ad7aae48ac4bd36b01326698785f1d235402ea6081e9f7de69a17`
-	Default Command: `["lein","repl"]`
...
# Wed, 18 Sep 2019 21:24:26 GMT
CMD ["jshell"]
# Thu, 03 Oct 2019 22:28:17 GMT
ENV LEIN_VERSION=2.9.1
# Thu, 03 Oct 2019 22:28:17 GMT
ENV LEIN_INSTALL=/usr/local/bin/
# Thu, 03 Oct 2019 22:28:18 GMT
WORKDIR /tmp
# Thu, 03 Oct 2019 22:28:20 GMT
RUN mkdir -p $LEIN_INSTALL && wget -q https://raw.githubusercontent.com/technomancy/leiningen/$LEIN_VERSION/bin/lein-pkg && echo "Comparing lein-pkg checksum ..." && sha1sum lein-pkg && echo "93be2c23ab4ff2fc4fcf531d7510ca4069b8d24a *lein-pkg" | sha1sum -c - && mv lein-pkg $LEIN_INSTALL/lein && chmod 0755 $LEIN_INSTALL/lein && wget -q https://github.com/technomancy/leiningen/releases/download/$LEIN_VERSION/leiningen-$LEIN_VERSION-standalone.zip && wget -q https://github.com/technomancy/leiningen/releases/download/$LEIN_VERSION/leiningen-$LEIN_VERSION-standalone.zip.asc && gpg --batch --keyserver pool.sks-keyservers.net --recv-key 2B72BF956E23DE5E830D50F6002AF007D1A7CC18 && echo "Verifying Jar file signature ..." && gpg --verify leiningen-$LEIN_VERSION-standalone.zip.asc && rm leiningen-$LEIN_VERSION-standalone.zip.asc && mkdir -p /usr/share/java && mv leiningen-$LEIN_VERSION-standalone.zip /usr/share/java/leiningen-$LEIN_VERSION-standalone.jar
# Thu, 03 Oct 2019 22:28:20 GMT
ENV PATH=/usr/java/openjdk-13/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/local/bin/
# Thu, 03 Oct 2019 22:28:20 GMT
ENV LEIN_ROOT=1
# Thu, 03 Oct 2019 22:28:24 GMT
RUN echo '(defproject dummy "" :dependencies [[org.clojure/clojure "1.10.1"]])' > project.clj   && lein deps && rm project.clj
# Thu, 03 Oct 2019 22:28:24 GMT
CMD ["lein" "repl"]
```
...
-	Layers:
	...
	-	`sha256:1bf2afcabdc11392870a02fdace1586d37843d71d30df389dfb2f46d69e4a76c`  
		...
		Size: 197.0 MB (196951574 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6d60ac96aafbea272b38a1139a14b8f6ec2458cd7b398e8c05b99c4d624dd18e`  
		Last Modified: Thu, 03 Oct 2019 22:37:09 GMT  
		Size: 13.1 MB (13137760 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cdd4a94a706e81c69d1ae23e34b78a2f97f4b4956adb109197b622594f3649a1`  
		Last Modified: Thu, 03 Oct 2019 22:37:09 GMT  
...
```console
$ docker pull clojure@sha256:f7261869cc63970d6cdaa55ac8aeabbdef687c21b52d158aafadd10fcb952af6
```
...
```console
$ docker pull clojure@sha256:ef6bdbd5c2c9a599800ffd213e7ee2a62eadfb90884e8a21c83002d45c59d7be
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **274.2 MB (274173641 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fd53653f610dbc589fe14b9b773846e9fbf63f7bc3ebb8d05635d1af87f0d81b`
-	Default Command: `["sh","-c","sleep 1 && exec clj"]`
...
# Wed, 18 Sep 2019 21:24:58 GMT
CMD ["jshell"]
# Thu, 03 Oct 2019 22:30:07 GMT
ENV CLOJURE_VERSION=1.10.1.469
# Thu, 03 Oct 2019 22:30:08 GMT
WORKDIR /tmp
# Thu, 03 Oct 2019 22:30:26 GMT
RUN apt-get update && apt-get install -y curl rlwrap wget && rm -rf /var/lib/apt/lists/* && wget https://download.clojure.org/install/linux-install-$CLOJURE_VERSION.sh && chmod +x linux-install-$CLOJURE_VERSION.sh && ./linux-install-$CLOJURE_VERSION.sh && clojure -e "(clojure-version)" && apt-get remove -y --purge curl wget
# Thu, 03 Oct 2019 22:30:26 GMT
CMD ["sh" "-c" "sleep 1 && exec clj"]
```
...
-	Layers:
	...
	-	`sha256:5b17f8416c98b249c89f950aa6ca2806f482aae6aaf3b4e4cb6e6c2996bd46a8`  
		...
		Size: 197.2 MB (197216286 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1f6236fa4bfa13e9fe07be48cb0c56cd518d0e420601dcbf2586b50cce107d83`  
		Last Modified: Thu, 03 Oct 2019 22:37:42 GMT  
		Size: 46.6 MB (46616025 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull clojure@sha256:5efce8526b690c1d11e6c21290966cccd4647bee7ce34cce9c3cd419c4569beb
```
...
```console
$ docker pull clojure@sha256:7b5983a80e3461ff275be5b91113fb40c7db7d597afaddb1df484d936dc401af
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **354.7 MB (354714303 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a419521aff8c336552ba30f10813df981f35e5901286546db9b4609cee1c586d`
-	Default Command: `["sh","-c","sleep 1 && exec clj"]`
...
# Wed, 18 Sep 2019 21:24:26 GMT
CMD ["jshell"]
# Thu, 03 Oct 2019 22:30:31 GMT
ENV CLOJURE_VERSION=1.10.1.469
# Thu, 03 Oct 2019 22:30:32 GMT
WORKDIR /tmp
# Thu, 03 Oct 2019 22:30:39 GMT
RUN wget https://download.clojure.org/install/linux-install-$CLOJURE_VERSION.sh && chmod +x linux-install-$CLOJURE_VERSION.sh && ./linux-install-$CLOJURE_VERSION.sh && clojure -e "(clojure-version)"
# Thu, 03 Oct 2019 22:30:39 GMT
CMD ["sh" "-c" "sleep 1 && exec clj"]
```
...
-	Layers:
	...
	-	`sha256:1bf2afcabdc11392870a02fdace1586d37843d71d30df389dfb2f46d69e4a76c`  
		...
		Size: 197.0 MB (196951574 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d84259afbda12d0ed93449a3a791fe5fe9bfe67c91872ca50ea73b450d0e40f2`  
		Last Modified: Thu, 03 Oct 2019 22:37:48 GMT  
		Size: 23.9 MB (23892189 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

## `clojure:openjdk-13-tools-deps-1.10.1.469-slim-buster`
...
### `clojure:openjdk-13-tools-deps-1.10.1.469-slim-buster` - linux; amd64
...
```console
$ docker pull clojure@sha256:cede0634f7635da6f582756ae45d550b4867197a25242525dcfca880a26a46a9
```
...
```console
$ docker pull clojure@sha256:065a84cf41827f45e1aff3b332775673f2658179ab3643beb12ddfc769d6e21c
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **349.1 MB (349116834 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:00dc333eee678b7dadffee29a4525935a5dddfe11c848877d9945d2b026f7433`
-	Default Command: `["lein","repl"]`
...
# Sat, 28 Sep 2019 00:26:59 GMT
CMD ["jshell"]
# Thu, 03 Oct 2019 22:31:01 GMT
ENV LEIN_VERSION=2.9.1
# Thu, 03 Oct 2019 22:31:01 GMT
ENV LEIN_INSTALL=/usr/local/bin/
# Thu, 03 Oct 2019 22:31:01 GMT
WORKDIR /tmp
# Thu, 03 Oct 2019 22:31:03 GMT
RUN mkdir -p $LEIN_INSTALL && wget -q https://raw.githubusercontent.com/technomancy/leiningen/$LEIN_VERSION/bin/lein-pkg && echo "Comparing lein-pkg checksum ..." && sha1sum lein-pkg && echo "93be2c23ab4ff2fc4fcf531d7510ca4069b8d24a *lein-pkg" | sha1sum -c - && mv lein-pkg $LEIN_INSTALL/lein && chmod 0755 $LEIN_INSTALL/lein && wget -q https://github.com/technomancy/leiningen/releases/download/$LEIN_VERSION/leiningen-$LEIN_VERSION-standalone.zip && wget -q https://github.com/technomancy/leiningen/releases/download/$LEIN_VERSION/leiningen-$LEIN_VERSION-standalone.zip.asc && gpg --batch --keyserver pool.sks-keyservers.net --recv-key 2B72BF956E23DE5E830D50F6002AF007D1A7CC18 && echo "Verifying Jar file signature ..." && gpg --verify leiningen-$LEIN_VERSION-standalone.zip.asc && rm leiningen-$LEIN_VERSION-standalone.zip.asc && mkdir -p /usr/share/java && mv leiningen-$LEIN_VERSION-standalone.zip /usr/share/java/leiningen-$LEIN_VERSION-standalone.jar
# Thu, 03 Oct 2019 22:31:03 GMT
ENV PATH=/usr/java/openjdk-14/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/local/bin/
# Thu, 03 Oct 2019 22:31:03 GMT
ENV LEIN_ROOT=1
# Thu, 03 Oct 2019 22:31:07 GMT
RUN echo '(defproject dummy "" :dependencies [[org.clojure/clojure "1.10.1"]])' > project.clj   && lein deps && rm project.clj
# Thu, 03 Oct 2019 22:31:08 GMT
CMD ["lein" "repl"]
```
...
-	Layers:
	...
	-	`sha256:95618932ab11aa147696330994280000a738b51a986fb1b4c3884c47ea028431`  
		...
		Size: 197.9 MB (197940301 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b0d3fef5acbe7139ec7d21ec3cb33ced162c2218432660635db7c48f98ccc73d`  
		Last Modified: Thu, 03 Oct 2019 22:38:02 GMT  
		Size: 13.1 MB (13137777 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e99e9f49dbf548b511193748bfb79021ab44e26840a1e3cb6597d2b5963c2a9c`  
		Last Modified: Thu, 03 Oct 2019 22:38:02 GMT  
...
```console
$ docker pull clojure@sha256:9150bd06de0211de37a602c13f03762195c12099d7c6a65e4c202acbb88c7bf7
```
...
```console
$ docker pull clojure@sha256:81a01e4230be341800374e878799d0a69b721cfd73051ad2302598eeda94614d
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **275.2 MB (275161192 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a31452e3396b20306a4f4338c34bbc8c51dec4b3d63c34210a23a3fb0456d516`
-	Default Command: `["sh","-c","sleep 1 && exec clj"]`
...
# Sat, 28 Sep 2019 00:27:19 GMT
CMD ["jshell"]
# Thu, 03 Oct 2019 22:32:50 GMT
ENV CLOJURE_VERSION=1.10.1.469
# Thu, 03 Oct 2019 22:32:50 GMT
WORKDIR /tmp
# Thu, 03 Oct 2019 22:33:08 GMT
RUN apt-get update && apt-get install -y curl rlwrap wget && rm -rf /var/lib/apt/lists/* && wget https://download.clojure.org/install/linux-install-$CLOJURE_VERSION.sh && chmod +x linux-install-$CLOJURE_VERSION.sh && ./linux-install-$CLOJURE_VERSION.sh && clojure -e "(clojure-version)" && apt-get remove -y --purge curl wget
# Thu, 03 Oct 2019 22:33:08 GMT
CMD ["sh" "-c" "sleep 1 && exec clj"]
```
...
-	Layers:
	...
	-	`sha256:b889880f0dd8400569ee70dc65568926061344b1e925390bac3e1750c9352571`  
		...
		Size: 198.2 MB (198204483 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cd806c4bee44759a06c2ac2122d5c6ed0ba84b8374c0a89849a4ac32096e26fc`  
		Last Modified: Thu, 03 Oct 2019 22:38:33 GMT  
		Size: 46.6 MB (46615379 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

## `clojure:openjdk-14-tools-deps-1.10.1.469`
...
```console
$ docker pull clojure@sha256:5533065dcfc2e7042d3abacef96769b38064ad85a14c4c4890d24fe0d89325a2
```
...
### `clojure:openjdk-14-tools-deps-1.10.1.469-buster` - linux; amd64

```console
$ docker pull clojure@sha256:afdaa8864bd5b07ad29e3f86cb7d076a6a514c541d1b63ed1c1b0a41f2a4a23c
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **355.7 MB (355703037 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3003ec7782b515fdd76cbad602cb5d0a8867037636ba886115cab67347db289f`
-	Default Command: `["sh","-c","sleep 1 && exec clj"]`
...
# Sat, 28 Sep 2019 00:26:59 GMT
CMD ["jshell"]
# Thu, 03 Oct 2019 22:33:14 GMT
ENV CLOJURE_VERSION=1.10.1.469
# Thu, 03 Oct 2019 22:33:14 GMT
WORKDIR /tmp
# Thu, 03 Oct 2019 22:33:21 GMT
RUN wget https://download.clojure.org/install/linux-install-$CLOJURE_VERSION.sh && chmod +x linux-install-$CLOJURE_VERSION.sh && ./linux-install-$CLOJURE_VERSION.sh && clojure -e "(clojure-version)"
# Thu, 03 Oct 2019 22:33:21 GMT
CMD ["sh" "-c" "sleep 1 && exec clj"]
```
...
-	Layers:
	...
	-	`sha256:95618932ab11aa147696330994280000a738b51a986fb1b4c3884c47ea028431`  
		...
		Size: 197.9 MB (197940301 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:37ff78e33827bbac10e2f47f6f737a3e8eddba49999b433cb9f76edde2b12b7a`  
		Last Modified: Thu, 03 Oct 2019 22:38:45 GMT  
		Size: 23.9 MB (23892195 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull clojure@sha256:2b1d2a8b643261415db12a570ef3f87c0acccac515e055951903082b5fba2e0d
```
...
```console
$ docker pull clojure@sha256:ebeb2fb8c295d54bfcfb116ae0c999cf4039fdf0185e1612be6ea8bc867f5197
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **237.0 MB (237010388 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9824d4eae1b417454aa2d60082508c1b15c923fb2d42ceb04114ff58ae993b8d`
-	Default Command: `["lein","repl"]`
...
# Sat, 14 Sep 2019 00:24:02 GMT
RUN set -eux; 		dpkgArch="$(dpkg --print-architecture)"; 	case "$dpkgArch" in 		amd64) upstreamArch='x64' ;; 		arm64) upstreamArch='aarch64' ;; 		*) echo >&2 "error: unsupported architecture: $dpkgArch" ;; 	esac; 		wget -O openjdk.tgz.asc "${JAVA_BASE_URL}${upstreamArch}_linux_${JAVA_URL_VERSION}.tar.gz.sign"; 	wget -O openjdk.tgz "${JAVA_BASE_URL}${upstreamArch}_linux_${JAVA_URL_VERSION}.tar.gz" --progress=dot:giga; 		export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --keyserver-options no-self-sigs-only --recv-keys CA5F11C6CE22644D42C6AC4492EF8D39DC13168F; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys EAC843EBD3EFDB98CC772FADA5CD6035332FA671; 	gpg --batch --list-sigs --keyid-format 0xLONG CA5F11C6CE22644D42C6AC4492EF8D39DC13168F 		| tee /dev/stderr 		| grep '0xA5CD6035332FA671' 		| grep 'Andrew Haley'; 	gpg --batch --verify openjdk.tgz.asc openjdk.tgz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME"; 		mkdir -p "$JAVA_HOME"; 	tar --extract 		--file openjdk.tgz 		--directory "$JAVA_HOME" 		--strip-components 1 		--no-same-owner 	; 	rm openjdk.tgz*; 			{ 		echo '#!/usr/bin/env bash'; 		echo 'set -Eeuo pipefail'; 		echo 'if ! [ -d "$JAVA_HOME" ]; then echo >&2 "error: missing JAVA_HOME environment variable"; exit 1; fi'; 		echo 'cacertsFile=; for f in "$JAVA_HOME/lib/security/cacerts" "$JAVA_HOME/jre/lib/security/cacerts"; do if [ -e "$f" ]; then cacertsFile="$f"; break; fi; done'; 		echo 'if [ -z "$cacertsFile" ] || ! [ -f "$cacertsFile" ]; then echo >&2 "error: failed to find cacerts file in $JAVA_HOME"; exit 1; fi'; 		echo 'trust extract --overwrite --format=java-cacerts --filter=ca-anchors --purpose=server-auth "$cacertsFile"'; 	} > /etc/ca-certificates/update.d/docker-openjdk; 	chmod +x /etc/ca-certificates/update.d/docker-openjdk; 	/etc/ca-certificates/update.d/docker-openjdk; 		find "$JAVA_HOME/lib" -name '*.so' -exec dirname '{}' ';' | sort -u > /etc/ld.so.conf.d/docker-openjdk.conf; 	ldconfig; 		javac -version; 	java -version
# Thu, 03 Oct 2019 22:19:40 GMT
ENV LEIN_VERSION=2.9.1
# Thu, 03 Oct 2019 22:19:40 GMT
ENV LEIN_INSTALL=/usr/local/bin/
# Thu, 03 Oct 2019 22:19:40 GMT
WORKDIR /tmp
# Thu, 03 Oct 2019 22:19:48 GMT
RUN mkdir -p $LEIN_INSTALL && wget -q https://raw.githubusercontent.com/technomancy/leiningen/$LEIN_VERSION/bin/lein-pkg && echo "Comparing lein-pkg checksum ..." && sha1sum lein-pkg && echo "93be2c23ab4ff2fc4fcf531d7510ca4069b8d24a *lein-pkg" | sha1sum -c - && mv lein-pkg $LEIN_INSTALL/lein && chmod 0755 $LEIN_INSTALL/lein && wget -q https://github.com/technomancy/leiningen/releases/download/$LEIN_VERSION/leiningen-$LEIN_VERSION-standalone.zip && wget -q https://github.com/technomancy/leiningen/releases/download/$LEIN_VERSION/leiningen-$LEIN_VERSION-standalone.zip.asc && gpg --batch --keyserver pool.sks-keyservers.net --recv-key 2B72BF956E23DE5E830D50F6002AF007D1A7CC18 && echo "Verifying Jar file signature ..." && gpg --verify leiningen-$LEIN_VERSION-standalone.zip.asc && rm leiningen-$LEIN_VERSION-standalone.zip.asc && mkdir -p /usr/share/java && mv leiningen-$LEIN_VERSION-standalone.zip /usr/share/java/leiningen-$LEIN_VERSION-standalone.jar
# Thu, 03 Oct 2019 22:19:48 GMT
ENV PATH=/usr/local/openjdk-8/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/local/bin/
# Thu, 03 Oct 2019 22:19:49 GMT
ENV LEIN_ROOT=1
# Thu, 03 Oct 2019 22:19:53 GMT
RUN echo '(defproject dummy "" :dependencies [[org.clojure/clojure "1.10.1"]])' > project.clj   && lein deps && rm project.clj
# Thu, 03 Oct 2019 22:19:53 GMT
CMD ["lein" "repl"]
```
...
-	Layers:
	...
	-	`sha256:f26b99e1adb1713c1c753f96d06c4ccb7f81df1b6daf266eab536ab38a315ba3`  
		...
		Size: 104.2 MB (104195047 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:819a9ee3209f7afaaeaf50efaef935eb11edaafd1c700d4b7ee6b55caa2b2c16`  
		Last Modified: Thu, 03 Oct 2019 22:35:03 GMT  
		Size: 13.1 MB (13139423 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e003d520a0ff3fa5f066423c85b527fd145bf9fefcf458251b9b2591deb00ad7`  
		Last Modified: Thu, 03 Oct 2019 22:35:03 GMT  
...
```console
$ docker pull clojure@sha256:c02a2750d45ca2de07a3f80ccc3043e43a5d59b9afd82e8b8e39d70cb10387a7
```
...
```console
$ docker pull clojure@sha256:e90ccbe01b36f4f28853596da851b1286616c37d05f3fabc05b1719c0831359a
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **278.5 MB (278530689 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b5cd5ef6f717f2f3fee2d7b009f12e9f8e3003eea5743367f28f2306fc4c5d55`
-	Default Command: `["boot","repl"]`
...
# Sat, 14 Sep 2019 00:24:02 GMT
RUN set -eux; 		dpkgArch="$(dpkg --print-architecture)"; 	case "$dpkgArch" in 		amd64) upstreamArch='x64' ;; 		arm64) upstreamArch='aarch64' ;; 		*) echo >&2 "error: unsupported architecture: $dpkgArch" ;; 	esac; 		wget -O openjdk.tgz.asc "${JAVA_BASE_URL}${upstreamArch}_linux_${JAVA_URL_VERSION}.tar.gz.sign"; 	wget -O openjdk.tgz "${JAVA_BASE_URL}${upstreamArch}_linux_${JAVA_URL_VERSION}.tar.gz" --progress=dot:giga; 		export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --keyserver-options no-self-sigs-only --recv-keys CA5F11C6CE22644D42C6AC4492EF8D39DC13168F; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys EAC843EBD3EFDB98CC772FADA5CD6035332FA671; 	gpg --batch --list-sigs --keyid-format 0xLONG CA5F11C6CE22644D42C6AC4492EF8D39DC13168F 		| tee /dev/stderr 		| grep '0xA5CD6035332FA671' 		| grep 'Andrew Haley'; 	gpg --batch --verify openjdk.tgz.asc openjdk.tgz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME"; 		mkdir -p "$JAVA_HOME"; 	tar --extract 		--file openjdk.tgz 		--directory "$JAVA_HOME" 		--strip-components 1 		--no-same-owner 	; 	rm openjdk.tgz*; 			{ 		echo '#!/usr/bin/env bash'; 		echo 'set -Eeuo pipefail'; 		echo 'if ! [ -d "$JAVA_HOME" ]; then echo >&2 "error: missing JAVA_HOME environment variable"; exit 1; fi'; 		echo 'cacertsFile=; for f in "$JAVA_HOME/lib/security/cacerts" "$JAVA_HOME/jre/lib/security/cacerts"; do if [ -e "$f" ]; then cacertsFile="$f"; break; fi; done'; 		echo 'if [ -z "$cacertsFile" ] || ! [ -f "$cacertsFile" ]; then echo >&2 "error: failed to find cacerts file in $JAVA_HOME"; exit 1; fi'; 		echo 'trust extract --overwrite --format=java-cacerts --filter=ca-anchors --purpose=server-auth "$cacertsFile"'; 	} > /etc/ca-certificates/update.d/docker-openjdk; 	chmod +x /etc/ca-certificates/update.d/docker-openjdk; 	/etc/ca-certificates/update.d/docker-openjdk; 		find "$JAVA_HOME/lib" -name '*.so' -exec dirname '{}' ';' | sort -u > /etc/ld.so.conf.d/docker-openjdk.conf; 	ldconfig; 		javac -version; 	java -version
# Thu, 03 Oct 2019 22:20:18 GMT
ENV BOOT_VERSION=2.8.3
# Thu, 03 Oct 2019 22:20:19 GMT
ENV BOOT_INSTALL=/usr/local/bin/
# Thu, 03 Oct 2019 22:20:19 GMT
WORKDIR /tmp
# Thu, 03 Oct 2019 22:20:20 GMT
RUN mkdir -p $BOOT_INSTALL && wget -q https://github.com/boot-clj/boot-bin/releases/download/latest/boot.sh && echo "Comparing installer checksum..." && echo "f717ef381f2863a4cad47bf0dcc61e923b3d2afb *boot.sh" | sha1sum -c - && mv boot.sh $BOOT_INSTALL/boot && chmod 0755 $BOOT_INSTALL/boot
# Thu, 03 Oct 2019 22:20:20 GMT
ENV PATH=/usr/local/openjdk-8/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/local/bin/
# Thu, 03 Oct 2019 22:20:20 GMT
ENV BOOT_AS_ROOT=yes
# Thu, 03 Oct 2019 22:21:33 GMT
RUN boot
# Thu, 03 Oct 2019 22:21:33 GMT
CMD ["boot" "repl"]
```
...
-	Layers:
	...
	-	`sha256:f26b99e1adb1713c1c753f96d06c4ccb7f81df1b6daf266eab536ab38a315ba3`  
		...
		Size: 104.2 MB (104195047 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:96c067cae5a4956270ad254443a0f87a2a5ecb39022338c8f1d988921a1fb760`  
		Last Modified: Thu, 03 Oct 2019 22:35:17 GMT  
		Size: 6.7 KB (6685 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b2c0b857c56094595b26a7a08cc0bd795e7b9d6b4a682ea697094c495efab533`  
		Last Modified: Thu, 03 Oct 2019 22:35:21 GMT  
		Size: 58.8 MB (58821252 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull clojure@sha256:aced3a11e5a3aeb8fd55b827ad392701c1c00b83be28af57ccdbb39e82f77494
```
...
```console
$ docker pull clojure@sha256:9bad1416f26c924c88eb00369c48d42bd3be96c583a918037e4e505091b9bb1b
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **243.6 MB (243594990 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9d071ce8b4d7fa02016c9b0698e9613a4225c3cb7df4c2dc4ab7757ed440447b`
-	Default Command: `["sh","-c","sleep 1 && exec clj"]`
...
# Sat, 14 Sep 2019 00:24:02 GMT
RUN set -eux; 		dpkgArch="$(dpkg --print-architecture)"; 	case "$dpkgArch" in 		amd64) upstreamArch='x64' ;; 		arm64) upstreamArch='aarch64' ;; 		*) echo >&2 "error: unsupported architecture: $dpkgArch" ;; 	esac; 		wget -O openjdk.tgz.asc "${JAVA_BASE_URL}${upstreamArch}_linux_${JAVA_URL_VERSION}.tar.gz.sign"; 	wget -O openjdk.tgz "${JAVA_BASE_URL}${upstreamArch}_linux_${JAVA_URL_VERSION}.tar.gz" --progress=dot:giga; 		export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --keyserver-options no-self-sigs-only --recv-keys CA5F11C6CE22644D42C6AC4492EF8D39DC13168F; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys EAC843EBD3EFDB98CC772FADA5CD6035332FA671; 	gpg --batch --list-sigs --keyid-format 0xLONG CA5F11C6CE22644D42C6AC4492EF8D39DC13168F 		| tee /dev/stderr 		| grep '0xA5CD6035332FA671' 		| grep 'Andrew Haley'; 	gpg --batch --verify openjdk.tgz.asc openjdk.tgz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME"; 		mkdir -p "$JAVA_HOME"; 	tar --extract 		--file openjdk.tgz 		--directory "$JAVA_HOME" 		--strip-components 1 		--no-same-owner 	; 	rm openjdk.tgz*; 			{ 		echo '#!/usr/bin/env bash'; 		echo 'set -Eeuo pipefail'; 		echo 'if ! [ -d "$JAVA_HOME" ]; then echo >&2 "error: missing JAVA_HOME environment variable"; exit 1; fi'; 		echo 'cacertsFile=; for f in "$JAVA_HOME/lib/security/cacerts" "$JAVA_HOME/jre/lib/security/cacerts"; do if [ -e "$f" ]; then cacertsFile="$f"; break; fi; done'; 		echo 'if [ -z "$cacertsFile" ] || ! [ -f "$cacertsFile" ]; then echo >&2 "error: failed to find cacerts file in $JAVA_HOME"; exit 1; fi'; 		echo 'trust extract --overwrite --format=java-cacerts --filter=ca-anchors --purpose=server-auth "$cacertsFile"'; 	} > /etc/ca-certificates/update.d/docker-openjdk; 	chmod +x /etc/ca-certificates/update.d/docker-openjdk; 	/etc/ca-certificates/update.d/docker-openjdk; 		find "$JAVA_HOME/lib" -name '*.so' -exec dirname '{}' ';' | sort -u > /etc/ld.so.conf.d/docker-openjdk.conf; 	ldconfig; 		javac -version; 	java -version
# Thu, 03 Oct 2019 22:22:40 GMT
ENV CLOJURE_VERSION=1.10.1.469
# Thu, 03 Oct 2019 22:22:41 GMT
WORKDIR /tmp
# Thu, 03 Oct 2019 22:22:50 GMT
RUN wget https://download.clojure.org/install/linux-install-$CLOJURE_VERSION.sh && chmod +x linux-install-$CLOJURE_VERSION.sh && ./linux-install-$CLOJURE_VERSION.sh && clojure -e "(clojure-version)"
# Thu, 03 Oct 2019 22:22:50 GMT
CMD ["sh" "-c" "sleep 1 && exec clj"]
```
...
-	Layers:
	...
	-	`sha256:f26b99e1adb1713c1c753f96d06c4ccb7f81df1b6daf266eab536ab38a315ba3`  
		...
		Size: 104.2 MB (104195047 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a1abc16fc63e2305e9bae4cbfd0b92cef432d238139d8017fecd021d93061008`  
		Last Modified: Thu, 03 Oct 2019 22:35:37 GMT  
		Size: 23.9 MB (23892238 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

## `clojure:openjdk-8-tools-deps-1.10.1.469`
...
### `clojure:openjdk-8-tools-deps-1.10.1.469` - linux; amd64
...
## `clojure:openjdk-8-tools-deps-1.10.1.469-stretch`
...
### `clojure:openjdk-8-tools-deps-1.10.1.469-stretch` - linux; amd64
...
## `clojure:tools-deps-1.10.1.469-slim-buster`
...
### `clojure:tools-deps-1.10.1.469-slim-buster` - linux; amd64
...
### `clojure:tools-deps-1.10.1.469-slim-buster` - linux; arm64 variant v8
...
## `clojure:tools-deps-1.10.1.469-stretch`
...
### `clojure:tools-deps-1.10.1.469-stretch` - linux; amd64
...
### `clojure:tools-deps-1.10.1.469-stretch` - linux; arm64 variant v8
