...
### `ghost:2.31.0-alpine` - linux; amd64
...
### `ghost:2.31.0-alpine` - linux; arm variant v6
...
### `ghost:2.31.0-alpine` - linux; arm variant v7
...
### `ghost:2.31.0-alpine` - linux; ppc64le
