...
- Environment:
  ...
  - `AEROSPIKE_VERSION=4.6.0.4`
  - `AEROSPIKE_SHA256=300fd39295c11683fce7507a7f0d9c0d0099d6bb8b4aec184ec02bfbf0e49e14`
...
### `dpkg` source package: `aerospike-server-community=4.6.0.4-1`

Binary Packages:

- `aerospike-server-community=4.6.0.4-1`
