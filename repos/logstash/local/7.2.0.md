...
- Created: `2019-06-20T17:37:31.03785792Z`
- Virtual Size: ~ 836.32 Mb  
...
### `rpm` package: `java-11-openjdk-11.0.3.7-0.el7_6.x86_64`
...
```console
$ yumdownloader --quiet --source --urls java-11-openjdk-11.0.3.7-0.el7_6
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/updates/Source//SPackages/java-11-openjdk-11.0.3.7-0.el7_6.src.rpm
```

### `rpm` package: `java-11-openjdk-devel-11.0.3.7-0.el7_6.x86_64`
...
```console
$ yumdownloader --quiet --source --urls java-11-openjdk-devel-11.0.3.7-0.el7_6
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/updates/Source//SPackages/java-11-openjdk-11.0.3.7-0.el7_6.src.rpm
...
### `rpm` package: `java-11-openjdk-headless-11.0.3.7-0.el7_6.x86_64`
...
```console
$ yumdownloader --quiet --source --urls java-11-openjdk-headless-11.0.3.7-0.el7_6
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/updates/Source//SPackages/java-11-openjdk-11.0.3.7-0.el7_6.src.rpm
