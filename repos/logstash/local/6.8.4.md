...
- Created: `2019-10-16T08:05:24.89800569Z`
- Virtual Size: ~ 902.57 Mb  
...
### `rpm` package: `java-1.8.0-openjdk-1.8.0.222.b10-1.el7_7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls java-1.8.0-openjdk-1.8.0.222.b10-1.el7_7
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/updates/Source//SPackages/java-1.8.0-openjdk-1.8.0.222.b10-1.el7_7.src.rpm
```

### `rpm` package: `java-1.8.0-openjdk-devel-1.8.0.222.b10-1.el7_7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls java-1.8.0-openjdk-devel-1.8.0.222.b10-1.el7_7
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/updates/Source//SPackages/java-1.8.0-openjdk-1.8.0.222.b10-1.el7_7.src.rpm
...
### `rpm` package: `java-1.8.0-openjdk-headless-1.8.0.222.b10-1.el7_7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls java-1.8.0-openjdk-headless-1.8.0.222.b10-1.el7_7
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/updates/Source//SPackages/java-1.8.0-openjdk-1.8.0.222.b10-1.el7_7.src.rpm
