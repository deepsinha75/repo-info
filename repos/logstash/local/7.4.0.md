...
- Created: `2019-09-27T10:32:08.3639958Z`
- Virtual Size: ~ 889.32 Mb  
...
### `rpm` package: `java-11-openjdk-11.0.4.11-1.el7_7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls java-11-openjdk-11.0.4.11-1.el7_7
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/updates/Source//SPackages/java-11-openjdk-11.0.4.11-1.el7_7.src.rpm
```

### `rpm` package: `java-11-openjdk-devel-11.0.4.11-1.el7_7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls java-11-openjdk-devel-11.0.4.11-1.el7_7
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/updates/Source//SPackages/java-11-openjdk-11.0.4.11-1.el7_7.src.rpm
...
### `rpm` package: `java-11-openjdk-headless-11.0.4.11-1.el7_7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls java-11-openjdk-headless-11.0.4.11-1.el7_7
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/updates/Source//SPackages/java-11-openjdk-11.0.4.11-1.el7_7.src.rpm
