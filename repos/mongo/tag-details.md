...
```console
$ docker pull mongo@sha256:a16cc1fc874a7b910fb8a4dc08cabb8f5e40b37bddee61d7cd04e1c28308f52a
```
...
```console
$ docker pull mongo@sha256:eb76e24d5f53cf4b5d81f5062f0d6cbf0556cff022c40a76065fb7f7edca750a
```
