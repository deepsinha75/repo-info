...
-	[`sapmachine:11.0.3`](#sapmachine1103)
-	[`sapmachine:12`](#sapmachine12)
-	[`sapmachine:12.0.1`](#sapmachine1201)
...
```console
$ docker pull sapmachine@sha256:55f064ca67013969c60d92f8d92f03ff59f6fc6506015d538a7a66bebc5bf212
```
...
```console
$ docker pull sapmachine@sha256:1ef15de7f09bce7b982c59d51b5399ba7179a3468db31f855607d496535f7367
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **240.5 MB (240541576 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3630fc92040a9155569c5b3368156193dd5ac9a637010fa98ed70781e8f77d41`
-	Default Command: `["jshell"]`
...
# Tue, 25 Jun 2019 00:20:29 GMT
RUN apt-get update     && apt-get install -y --no-install-recommends wget ca-certificates gnupg2     && rm -rf /var/lib/apt/lists/*
# Tue, 25 Jun 2019 00:21:38 GMT
RUN export GNUPGHOME="$(mktemp -d)"     && wget -q -O - http://dist.sapmachine.io/debian/sapmachine.old.key | gpg --batch --import     && gpg --batch --export --armor 'DA4C 00C1 BDB1 3763 8608 4E20 C7EB 4578 740A EEA2' > /etc/apt/trusted.gpg.d/sapmachine.old.gpg.asc     && wget -q -O - http://dist.sapmachine.io/debian/sapmachine.key | gpg --batch --import     && gpg --batch --export --armor 'CACB 9FE0 9150 307D 1D22 D829 6275 4C3B 3ABC FE23' > /etc/apt/trusted.gpg.d/sapmachine.gpg.asc     && gpgconf --kill all && rm -rf "$GNUPGHOME"     && echo "deb http://dist.sapmachine.io/debian/amd64/ ./" > /etc/apt/sources.list.d/sapmachine.list     && apt-get update     && apt-get -y --no-install-recommends install sapmachine-12-jdk=12.0.1     && rm -rf /var/lib/apt/lists/*
# Tue, 25 Jun 2019 00:21:38 GMT
CMD ["jshell"]
```
...
-	Layers:
	...
	-	`sha256:6550984d42678a759d7c845d7822a551e07aaad241fd0f9d712340ef55ac7909`  
		...
		Size: 7.6 MB (7555233 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:adec1ca52a70b366b1892352a29bf123ed4ac448953c1796ebf4930074ef6e11`  
		Last Modified: Tue, 25 Jun 2019 00:22:28 GMT  
		Size: 206.3 MB (206265472 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
