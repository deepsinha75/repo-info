...
### `php:7.4.0alpha2-zts-alpine` - linux; amd64
...
### `php:7.4.0alpha2-zts-alpine` - linux; arm variant v7
...
### `php:7.4.0alpha2-zts-alpine` - linux; arm64 variant v8
...
### `php:7.4.0alpha2-zts-alpine` - linux; 386
...
### `php:7.4.0alpha2-zts-alpine` - linux; ppc64le
