## `php:7.1.33-apache-buster`

```console
$ docker pull php@sha256:ead0bc4d0766dd03dc2cb6609368e39aa21ce25d6ec42e63e31f067d995562de
```
...
### `php:7.1.33-apache-buster` - linux; amd64
...
### `php:7.1.33-apache-buster` - linux; arm variant v5

```console
$ docker pull php@sha256:0237ba7649ba9ab655e256529d3a4934b4f362c84ac2ac42da15282b7735c034
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **126.5 MB (126466548 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1f6752e4543a7ed2cc1be19c0b6ed9c90a8d61e9198103c5f2709c24d5928f4a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
### `php:7.1.33-apache-buster` - linux; arm variant v7
...
### `php:7.1.33-apache-buster` - linux; arm64 variant v8
...
### `php:7.1.33-apache-buster` - linux; 386
...
### `php:7.1.33-apache-buster` - linux; ppc64le
...
### `php:7.1.33-apache-buster` - linux; s390x
