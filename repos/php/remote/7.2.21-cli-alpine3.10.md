...
```console
$ docker pull php@sha256:8122e0adb830a402eb21c6c6e97a2450a4f30c121ea36fd69183fc2442bf14ac
```
...
### `php:7.2.21-cli-alpine3.10` - linux; amd64
...
### `php:7.2.21-cli-alpine3.10` - linux; arm variant v7
...
### `php:7.2.21-cli-alpine3.10` - linux; arm64 variant v8
...
### `php:7.2.21-cli-alpine3.10` - linux; 386

```console
$ docker pull php@sha256:69e22fe05f96a49250c844f37f3bf97af0249892af3a46ff275947ab78825df4
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **33.0 MB (33020724 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cbf1f5198449819dd86672204b00d01d1c432a643fc6c152a7925f2451c29877`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
### `php:7.2.21-cli-alpine3.10` - linux; ppc64le
