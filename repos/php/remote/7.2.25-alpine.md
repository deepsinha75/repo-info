...
```console
$ docker pull php@sha256:1c9b93116a70023f8cc5d7b82b48f94a7562f639a9b9ac18edde8b6a60c28366
```
...
### `php:7.2.25-alpine` - linux; arm variant v7
...
### `php:7.2.25-alpine` - linux; arm64 variant v8
...
### `php:7.2.25-alpine` - linux; 386

```console
$ docker pull php@sha256:58268736ed805b56aaf6c79978ebf392a9a8b198b43faaa22c82d62f7b4e9b70
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **31.6 MB (31601492 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b84b6183d8c72a1a398b78b22d50a4c78a944ab11ed67395db670a73c085d4f9`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
### `php:7.2.25-alpine` - linux; ppc64le
