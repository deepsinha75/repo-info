...
```console
$ docker pull php@sha256:d11c770ee932ed926fb4332398eb5ab7123101c6a3528bb62811762608abc707
```
...
### `php:7.3.12-stretch` - linux; amd64
...
### `php:7.3.12-stretch` - linux; arm variant v7
...
### `php:7.3.12-stretch` - linux; arm64 variant v8
...
### `php:7.3.12-stretch` - linux; ppc64le
