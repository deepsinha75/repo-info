...
### `php:7.2.22-apache-buster` - linux; amd64
...
### `php:7.2.22-apache-buster` - linux; arm variant v5
...
### `php:7.2.22-apache-buster` - linux; arm variant v7
...
### `php:7.2.22-apache-buster` - linux; arm64 variant v8
...
### `php:7.2.22-apache-buster` - linux; 386
...
### `php:7.2.22-apache-buster` - linux; ppc64le
