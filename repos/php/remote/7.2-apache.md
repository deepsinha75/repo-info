...
```console
$ docker pull php@sha256:74d7d4bd11bd9906131accca43fd0bfed8e9e49cd35e0afa6aa0f3e90a5e714a
```
...
```console
$ docker pull php@sha256:1457d432f99b402e506b5427f8b340e957e8b079cc56283e28d3aff05202b2d6
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **126.2 MB (126173861 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6d0d2b9a6520fe87430533de203e3bd0b372393d2b13ac3c38b761c33298863f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
