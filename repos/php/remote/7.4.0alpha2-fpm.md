...
### `php:7.4.0alpha2-fpm` - linux; amd64
...
### `php:7.4.0alpha2-fpm` - linux; arm variant v5
...
### `php:7.4.0alpha2-fpm` - linux; arm variant v7
...
### `php:7.4.0alpha2-fpm` - linux; arm64 variant v8
...
### `php:7.4.0alpha2-fpm` - linux; ppc64le
