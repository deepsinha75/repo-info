...
```console
$ docker pull php@sha256:5c82a372bdc1ed9c93ea8ef9bb0253351cc4d7e718f60c5187c2212a61be922c
```
...
### `php:7.3.8-apache-buster` - linux; arm variant v5
...
### `php:7.3.8-apache-buster` - linux; arm variant v7
...
### `php:7.3.8-apache-buster` - linux; arm64 variant v8
