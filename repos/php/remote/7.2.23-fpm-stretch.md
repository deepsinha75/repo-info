...
```console
$ docker pull php@sha256:2d7f7cfef609f15eb7aa38e42ab24eee8a50646b5b80e6065cf172553a51c52d
```
...
```console
$ docker pull php@sha256:f2abc42059a3ead3e9b080749799684911c239da635ae8190b0fd686c811087e
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **118.9 MB (118911645 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d89eac51e036d880971680db4b4726ee5edbad40568f772e6fe9ea01d6328c50`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
