...
```console
$ docker pull php@sha256:67e4b8a20adcc400a75421444f9962defbe20018a866de4ee3ccde7cd11edbbe
```
...
### `php:7.4.0RC3-fpm-alpine3.10` - linux; amd64
...
### `php:7.4.0RC3-fpm-alpine3.10` - linux; arm variant v7
...
### `php:7.4.0RC3-fpm-alpine3.10` - linux; arm64 variant v8
...
### `php:7.4.0RC3-fpm-alpine3.10` - linux; ppc64le
