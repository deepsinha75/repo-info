...
```console
$ docker pull php@sha256:40628ff877a152ba3ecda48d8373073a0e8018d4ebf0550b3607087992ee3cf0
```
...
### `php:7.3.12-apache-stretch` - linux; amd64
...
### `php:7.3.12-apache-stretch` - linux; ppc64le
