...
```console
$ docker pull php@sha256:c98d29eb635c3085d8201582a33c128f9149110111687bb4be17d63972e4d4ad
```
...
### `php:7.4.0RC1-alpine` - linux; amd64
...
### `php:7.4.0RC1-alpine` - linux; arm variant v6
...
### `php:7.4.0RC1-alpine` - linux; arm variant v7
...
### `php:7.4.0RC1-alpine` - linux; ppc64le
