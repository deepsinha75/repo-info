...
```console
$ docker pull php@sha256:0cce8ffe0a7ddbb09ac94da1dfb391f2be63c969de547be8cb4938746b0cbdd4
```
...
```console
$ docker pull php@sha256:20b45bbd27912831990362ef08999b187b138fa48f2c3412b39332cd768811b9
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **122.7 MB (122677246 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a37e42cfcb8fd907c5aca3d5b983af7171147f0c14f76a9858e578ca6c0a2275`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
