## `php:7.2.24-fpm-alpine`

```console
$ docker pull php@sha256:c76a6a49b16cc532be9d590e3cf157c867359e0eae05dc1de0692e7934b744ef
```
...
### `php:7.2.24-fpm-alpine` - linux; amd64
...
### `php:7.2.24-fpm-alpine` - linux; arm variant v6
...
### `php:7.2.24-fpm-alpine` - linux; arm variant v7
...
### `php:7.2.24-fpm-alpine` - linux; arm64 variant v8
...
### `php:7.2.24-fpm-alpine` - linux; 386

```console
$ docker pull php@sha256:97c8d1be9b53774867b6660c2d7caa1e605a4bf5a320576172f7c89669b66b2e
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **31.7 MB (31693549 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1914a1fb0d5f4b16497ac0b76a304b398618d5d697e093f22d2ba5e3c2057a6a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
### `php:7.2.24-fpm-alpine` - linux; ppc64le
