...
### `php:7.3.12-cli-alpine` - linux; amd64
...
### `php:7.3.12-cli-alpine` - linux; arm variant v6
...
### `php:7.3.12-cli-alpine` - linux; arm variant v7
...
### `php:7.3.12-cli-alpine` - linux; arm64 variant v8
...
### `php:7.3.12-cli-alpine` - linux; 386
...
### `php:7.3.12-cli-alpine` - linux; ppc64le
