## `php:7.1.30-cli-alpine3.10`

```console
$ docker pull php@sha256:6910a8b11c5fe2dd3d94b87168d06caae5fbe7c33f78d53999f2de09c8f939e4
```
...
### `php:7.1.30-cli-alpine3.10` - linux; amd64
...
### `php:7.1.30-cli-alpine3.10` - linux; arm variant v6

```console
$ docker pull php@sha256:0f0767c8a79b9f249d4c6a0862562032040c7b789b256fcbb643c9887b56c4d1
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **30.0 MB (29971384 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2358c3167e73653b4cf94b06b9497d4c551b8ae304f8c66daa2c9932cd715d86`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
### `php:7.1.30-cli-alpine3.10` - linux; arm variant v7

```console
$ docker pull php@sha256:dd842392bfa1c5f385b517ce08955c3eec58c3813d338c1bdab26d30fc21446e
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **28.7 MB (28695251 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a1cd72c857bf73f9c30d9577162ecc59638241179cb034a622d19dd624095e30`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
### `php:7.1.30-cli-alpine3.10` - linux; arm64 variant v8

```console
$ docker pull php@sha256:d6aa1976443697c3653ae6cd9cd81ffb22f233ee40fcc2ebb46b211129f6b5e9
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **31.1 MB (31055700 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3d13f4ce79daffc34ff32f777ede740eada373d0bd39c085f58be35c1a684418`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
### `php:7.1.30-cli-alpine3.10` - linux; 386

```console
$ docker pull php@sha256:4a559f34b49f60a7fcf512bd0a3c44de646b0c65154a1bfe1777a12d149c35f5
```
...
-	Total Size: **31.8 MB (31751119 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d47d7ce0bd8fcdfe86228e457294db7b7599b14765f21c0af73555550e34fdd4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
### `php:7.1.30-cli-alpine3.10` - linux; ppc64le

```console
$ docker pull php@sha256:007c29e7fc5418c16477e53a15c4ee6eee045e9ba75c08e8719b656fa342755b
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **32.6 MB (32572626 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bf9ca758bbd931ed207a3aa4b2bd75877a45e08aa0010373fe87235cf75f639e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
### `php:7.1.30-cli-alpine3.10` - linux; s390x
