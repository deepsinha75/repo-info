...
```console
$ docker pull php@sha256:087aeb3bf42e7ae01601a4dc3e7f085f586cecd44b3ad8652e07867af01baa32
```
...
```console
$ docker pull php@sha256:a28f7401408dda66179eb7fee80fc0b4c009b1fc77fc066ec2cbeda87f245f3c
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **32.7 MB (32660142 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ab4604a1dde6bb0e5e62f6a2159502d39c84308931ed0fe09246551b9ce725be`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
