...
```console
$ docker pull php@sha256:01ffdba041ea131338671fbac70084399935ec1764b579583c26acf2d158ad6a
```
...
### `php:7.4.0RC4-buster` - linux; amd64
...
### `php:7.4.0RC4-buster` - linux; arm variant v5
...
### `php:7.4.0RC4-buster` - linux; arm variant v7
...
### `php:7.4.0RC4-buster` - linux; arm64 variant v8
