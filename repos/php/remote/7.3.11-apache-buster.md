...
```console
$ docker pull php@sha256:306bc70854ac12956a0c412c9ce906007bdc962cbf47cdb60b0381820a6f31a5
```
...
### `php:7.3.11-apache-buster` - linux; amd64
...
### `php:7.3.11-apache-buster` - linux; arm64 variant v8
...
### `php:7.3.11-apache-buster` - linux; 386
...
### `php:7.3.11-apache-buster` - linux; ppc64le
