...
### `php:7.3.11-cli-stretch` - linux; amd64
...
### `php:7.3.11-cli-stretch` - linux; arm variant v5
...
### `php:7.3.11-cli-stretch` - linux; arm64 variant v8
...
### `php:7.3.11-cli-stretch` - linux; 386
...
### `php:7.3.11-cli-stretch` - linux; ppc64le
