...
```console
$ docker pull php@sha256:fac100e9b206920a1da1c7bd226a181ded2d2363fabb495d5fa4c8a65f127c73
```
...
```console
$ docker pull php@sha256:7ea5c9f3b25d6382b54d2e6d3add9f880a10dbad869840f11d55c5207cd2c4b5
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **32.1 MB (32086417 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b86e3263d8eab7f085bfc0f14bcfba955a42f97580301d5bc0ac7a5acf76ab7a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
