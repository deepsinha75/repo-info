...
### `php:7.1.33-cli-alpine3.10` - linux; amd64
...
### `php:7.1.33-cli-alpine3.10` - linux; arm64 variant v8
...
### `php:7.1.33-cli-alpine3.10` - linux; 386
...
### `php:7.1.33-cli-alpine3.10` - linux; ppc64le
...
### `php:7.1.33-cli-alpine3.10` - linux; s390x
