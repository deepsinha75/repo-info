...
### `php:7.4.0RC1-buster` - linux; amd64
...
### `php:7.4.0RC1-buster` - linux; arm variant v5
...
### `php:7.4.0RC1-buster` - linux; arm variant v7
...
### `php:7.4.0RC1-buster` - linux; arm64 variant v8
...
### `php:7.4.0RC1-buster` - linux; ppc64le
