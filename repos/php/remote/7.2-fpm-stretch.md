...
```console
$ docker pull php@sha256:f9fb61fac4fdf7e2f82a5943eeda5576ef2aa50fee96cfcea6a70889ba26b722
```
...
```console
$ docker pull php@sha256:ddb40952df62f600eab84031a2c90f7845a8cc54ab954c23181c5109263b44f9
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **118.0 MB (117993516 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9d286dfe10dc115ffafe2e72d2aed1cee605a857370a24fb424c313cf0da4f58`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
