...
### `nextcloud:14.0.13-rc-apache` - linux; amd64
...
### `nextcloud:14.0.13-rc-apache` - linux; arm variant v5
...
### `nextcloud:14.0.13-rc-apache` - linux; arm variant v7
...
### `nextcloud:14.0.13-rc-apache` - linux; arm64 variant v8
...
### `nextcloud:14.0.13-rc-apache` - linux; 386
...
### `nextcloud:14.0.13-rc-apache` - linux; ppc64le
