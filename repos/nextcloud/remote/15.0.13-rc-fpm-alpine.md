...
### `nextcloud:15.0.13-rc-fpm-alpine` - linux; amd64
...
### `nextcloud:15.0.13-rc-fpm-alpine` - linux; arm variant v6
...
### `nextcloud:15.0.13-rc-fpm-alpine` - linux; arm variant v7
...
### `nextcloud:15.0.13-rc-fpm-alpine` - linux; arm64 variant v8
...
### `nextcloud:15.0.13-rc-fpm-alpine` - linux; 386
...
### `nextcloud:15.0.13-rc-fpm-alpine` - linux; ppc64le
