...
```console
$ docker pull nextcloud@sha256:ea0533887aa893025887555db8c7c374d758abc783faeb152d3541c3214ca686
```
...
### `nextcloud:16.0.4-fpm-alpine` - linux; amd64
...
### `nextcloud:16.0.4-fpm-alpine` - linux; arm variant v6
...
### `nextcloud:16.0.4-fpm-alpine` - linux; arm variant v7
...
### `nextcloud:16.0.4-fpm-alpine` - linux; 386
...
### `nextcloud:16.0.4-fpm-alpine` - linux; ppc64le
