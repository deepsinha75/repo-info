...
### `nextcloud:15.0.11RC1-fpm-alpine` - linux; amd64
...
### `nextcloud:15.0.11RC1-fpm-alpine` - linux; arm variant v6
...
### `nextcloud:15.0.11RC1-fpm-alpine` - linux; arm variant v7
...
### `nextcloud:15.0.11RC1-fpm-alpine` - linux; arm64 variant v8
...
### `nextcloud:15.0.11RC1-fpm-alpine` - linux; ppc64le
