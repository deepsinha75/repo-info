...
### `nextcloud:17-beta` - linux; arm variant v5
...
### `nextcloud:17-beta` - linux; arm variant v7
...
### `nextcloud:17-beta` - linux; arm64 variant v8
...
### `nextcloud:17-beta` - linux; ppc64le
