...
### `nextcloud:17.0.1-rc-apache` - linux; amd64
...
### `nextcloud:17.0.1-rc-apache` - linux; arm variant v5
...
### `nextcloud:17.0.1-rc-apache` - linux; arm variant v7
...
### `nextcloud:17.0.1-rc-apache` - linux; arm64 variant v8
...
### `nextcloud:17.0.1-rc-apache` - linux; 386
...
### `nextcloud:17.0.1-rc-apache` - linux; ppc64le
