...
- Created: `2019-09-19T01:20:01.735400422Z`
...
'http://security.ubuntu.com/ubuntu/pool/main/l/linux/linux_4.4.0-164.192.dsc' linux_4.4.0-164.192.dsc 11938 SHA256:879d9a643e2da609bca6583f88bcff273ea4a96ad939fd809080e061044a0c03
...
'http://security.ubuntu.com/ubuntu/pool/main/l/linux/linux_4.4.0-164.192.diff.gz' linux_4.4.0-164.192.diff.gz 15719645 SHA256:ce937f0abfe950d9cd21ea548d523d63eca9c429543d18b0ef631b4c98ecd6bf
```
...
- `libpython2.7:amd64=2.7.12-1ubuntu0~16.04.8`
- `libpython2.7-dev:amd64=2.7.12-1ubuntu0~16.04.8`
...
- `libpython3.5:amd64=3.5.2-2ubuntu0~16.04.8`
...
### `dpkg` source package: `ros-kinetic-collada-parser=1.12.12-0xenial-20190608-042308-0800`

Binary Packages:

- `ros-kinetic-collada-parser=1.12.12-0xenial-20190608-042308-0800`
...
### `dpkg` source package: `ros-kinetic-collada-urdf=1.12.12-0xenial-20190608-042939-0800`

Binary Packages:

- `ros-kinetic-collada-urdf=1.12.12-0xenial-20190608-042939-0800`
...
### `dpkg` source package: `ros-kinetic-control-msgs=1.5.0-0xenial-20190607-191204-0800`

Binary Packages:

- `ros-kinetic-control-msgs=1.5.0-0xenial-20190607-191204-0800`
...
### `dpkg` source package: `ros-kinetic-diagnostic-aggregator=1.9.3-0xenial-20190608-034427-0800`

Binary Packages:

- `ros-kinetic-diagnostic-aggregator=1.9.3-0xenial-20190608-034427-0800`
...
### `dpkg` source package: `ros-kinetic-diagnostic-analysis=1.9.3-0xenial-20190608-041715-0800`

Binary Packages:

- `ros-kinetic-diagnostic-analysis=1.9.3-0xenial-20190608-041715-0800`
...
### `dpkg` source package: `ros-kinetic-diagnostic-common-diagnostics=1.9.3-0xenial-20190608-111701-0800`

Binary Packages:

- `ros-kinetic-diagnostic-common-diagnostics=1.9.3-0xenial-20190608-111701-0800`
...
### `dpkg` source package: `ros-kinetic-diagnostic-updater=1.9.3-0xenial-20190608-034456-0800`

Binary Packages:

- `ros-kinetic-diagnostic-updater=1.9.3-0xenial-20190608-034456-0800`
...
### `dpkg` source package: `ros-kinetic-diagnostics=1.9.3-0xenial-20190608-112606-0800`

Binary Packages:

- `ros-kinetic-diagnostics=1.9.3-0xenial-20190608-112606-0800`
...
### `dpkg` source package: `ros-kinetic-eigen-conversions=1.11.9-0xenial-20190607-190420-0800`

Binary Packages:

- `ros-kinetic-eigen-conversions=1.11.9-0xenial-20190607-190420-0800`
...
### `dpkg` source package: `ros-kinetic-eigen-stl-containers=0.1.8-0xenial-20190607-180921-0800`

Binary Packages:

- `ros-kinetic-eigen-stl-containers=0.1.8-0xenial-20190607-180921-0800`
...
### `dpkg` source package: `ros-kinetic-executive-smach=2.0.1-0xenial-20190608-133644-0800`

Binary Packages:

- `ros-kinetic-executive-smach=2.0.1-0xenial-20190608-133644-0800`
...
### `dpkg` source package: `ros-kinetic-geometric-shapes=0.5.4-1xenial-20190607-215535-0800`

Binary Packages:

- `ros-kinetic-geometric-shapes=0.5.4-1xenial-20190607-215535-0800`
...
### `dpkg` source package: `ros-kinetic-geometry=1.11.9-0xenial-20190608-162728-0800`

Binary Packages:

- `ros-kinetic-geometry=1.11.9-0xenial-20190608-162728-0800`
...
### `dpkg` source package: `ros-kinetic-joint-state-publisher=1.12.13-0xenial-20190608-050036-0800`

Binary Packages:

- `ros-kinetic-joint-state-publisher=1.12.13-0xenial-20190608-050036-0800`
...
### `dpkg` source package: `ros-kinetic-kdl-conversions=1.11.9-0xenial-20190607-190127-0800`

Binary Packages:

- `ros-kinetic-kdl-conversions=1.11.9-0xenial-20190607-190127-0800`
...
### `dpkg` source package: `ros-kinetic-kdl-parser=1.12.11-0xenial-20190608-035540-0800`

Binary Packages:

- `ros-kinetic-kdl-parser=1.12.11-0xenial-20190608-035540-0800`
...
### `dpkg` source package: `ros-kinetic-octomap=1.8.1-0xenial-20190607-171237-0800`

Binary Packages:

- `ros-kinetic-octomap=1.8.1-0xenial-20190607-171237-0800`
...
### `dpkg` source package: `ros-kinetic-orocos-kdl=1.3.1-0xenial-20190607-171314-0800`

Binary Packages:

- `ros-kinetic-orocos-kdl=1.3.1-0xenial-20190607-171314-0800`
...
### `dpkg` source package: `ros-kinetic-python-orocos-kdl=1.3.1-0xenial-20190607-181050-0800`

Binary Packages:

- `ros-kinetic-python-orocos-kdl=1.3.1-0xenial-20190607-181050-0800`
...
### `dpkg` source package: `ros-kinetic-python-qt-binding=0.3.4-0xenial-20190607-212552-0800`

Binary Packages:

- `ros-kinetic-python-qt-binding=0.3.4-0xenial-20190607-212552-0800`
...
### `dpkg` source package: `ros-kinetic-random-numbers=0.3.1-0xenial-20190607-171706-0800`

Binary Packages:

- `ros-kinetic-random-numbers=0.3.1-0xenial-20190607-171706-0800`
...
### `dpkg` source package: `ros-kinetic-resource-retriever=1.12.4-0xenial-20190607-215136-0800`

Binary Packages:

- `ros-kinetic-resource-retriever=1.12.4-0xenial-20190607-215136-0800`
...
### `dpkg` source package: `ros-kinetic-robot-model=1.12.11-0xenial-20190608-051453-0800`

Binary Packages:

- `ros-kinetic-robot-model=1.12.11-0xenial-20190608-051453-0800`
...
### `dpkg` source package: `ros-kinetic-robot-state-publisher=1.13.7-1xenial-20190827-223736+0000`

Binary Packages:

- `ros-kinetic-robot-state-publisher=1.13.7-1xenial-20190827-223736+0000`
...
### `dpkg` source package: `ros-kinetic-robot=1.3.2-0xenial-20190827-231235+0000`

Binary Packages:

- `ros-kinetic-robot=1.3.2-0xenial-20190827-231235+0000`
...
### `dpkg` source package: `ros-kinetic-self-test=1.9.3-0xenial-20190608-035237-0800`

Binary Packages:

- `ros-kinetic-self-test=1.9.3-0xenial-20190608-035237-0800`
...
### `dpkg` source package: `ros-kinetic-smach-msgs=2.0.1-0xenial-20190607-190854-0800`

Binary Packages:

- `ros-kinetic-smach-msgs=2.0.1-0xenial-20190607-190854-0800`
...
### `dpkg` source package: `ros-kinetic-smach-ros=2.0.1-0xenial-20190608-043715-0800`

Binary Packages:

- `ros-kinetic-smach-ros=2.0.1-0xenial-20190608-043715-0800`
...
### `dpkg` source package: `ros-kinetic-smach=2.0.1-0xenial-20190607-165209-0800`

Binary Packages:

- `ros-kinetic-smach=2.0.1-0xenial-20190607-165209-0800`
...
### `dpkg` source package: `ros-kinetic-tf-conversions=1.11.9-0xenial-20190608-155050-0800`

Binary Packages:

- `ros-kinetic-tf-conversions=1.11.9-0xenial-20190608-155050-0800`
...
### `dpkg` source package: `ros-kinetic-tf2-kdl=0.5.20-0xenial-20190608-051410-0800`

Binary Packages:

- `ros-kinetic-tf2-kdl=0.5.20-0xenial-20190608-051410-0800`
...
### `dpkg` source package: `ros-kinetic-urdf-parser-plugin=1.12.12-0xenial-20190607-172532-0800`

Binary Packages:

- `ros-kinetic-urdf-parser-plugin=1.12.12-0xenial-20190607-172532-0800`
...
### `dpkg` source package: `ros-kinetic-urdf=1.12.12-0xenial-20190608-034840-0800`

Binary Packages:

- `ros-kinetic-urdf=1.12.12-0xenial-20190608-034840-0800`
...
### `dpkg` source package: `ros-kinetic-xacro=1.11.3-0xenial-20190608-040059-0800`

Binary Packages:

- `ros-kinetic-xacro=1.11.3-0xenial-20190608-040059-0800`
...
- `libudev-dev:amd64=229-4ubuntu21.22`
