...
```console
$ docker pull websphere-liberty@sha256:c80f84b766b77e4cd6c412cb00557642773cecdcd95ddf80c18828528b175e5e
```
...
```console
$ docker pull websphere-liberty@sha256:d9a70af2800b584a8e8cb71059da9d3777bc72bf0de0bef1a93f30fd3de2d864
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **189.9 MB (189868364 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7f0e03d6b25a4abe1f9d28f552464c529b9ac4d4208b92187d71ec2da6a7a0fb`
-	Entrypoint: `["\/opt\/ibm\/helpers\/runtime\/docker-server.sh"]`
-	Default Command: `["\/opt\/ibm\/wlp\/bin\/server","run","defaultServer"]`
