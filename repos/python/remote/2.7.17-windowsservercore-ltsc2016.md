...
```console
$ docker pull python@sha256:4f60eb6640d201fca4076f76d3f4092604a77ce9f3db8b75aeb94ae6680ed236
```
...
### `python:2.7.17-windowsservercore-ltsc2016` - windows version 10.0.14393.3274; amd64
