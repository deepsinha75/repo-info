...
```console
$ docker pull python@sha256:f0aa9dfce917bc55c05b3e7e2cc6a6e86434446b468f5049bd4176640ee082cb
```
...
### `python:3.7-windowsservercore-1809` - windows version 10.0.17763.864; amd64
