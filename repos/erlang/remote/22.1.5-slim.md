...
### `erlang:22.1.5-slim` - linux; amd64
...
### `erlang:22.1.5-slim` - linux; arm variant v7
...
### `erlang:22.1.5-slim` - linux; ppc64le
...
### `erlang:22.1.5-slim` - linux; s390x
