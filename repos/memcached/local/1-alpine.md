...
- Created: `2019-08-29T21:53:05.454023838Z`
- Virtual Size: ~ 9.01 Mb  
...
```console
libevent-2.1.10-r0 description:
An event notification library

libevent-2.1.10-r0 webpage:
http://libevent.org/

libevent-2.1.10-r0 installed size:
692224

libevent-2.1.10-r0 license:
BSD-3-Clause
