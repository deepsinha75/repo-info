...
- Created: `2019-10-19T08:09:24.226582621Z`
...
### `dpkg` source package: `ghostscript=9.26a~dfsg-0+deb9u5`

Binary Packages:

- `ghostscript=9.26a~dfsg-0+deb9u5`
- `libgs9:amd64=9.26a~dfsg-0+deb9u5`
...
- http://snapshot.debian.org/package/ghostscript/9.26a~dfsg-0+deb9u5/
