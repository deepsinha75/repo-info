...
### `nginx:1.17.1-alpine` - linux; arm variant v6
...
### `nginx:1.17.1-alpine` - linux; arm64 variant v8
...
### `nginx:1.17.1-alpine` - linux; ppc64le
...
### `nginx:1.17.1-alpine` - linux; s390x
