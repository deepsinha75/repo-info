...
- Created: `2019-08-27T22:20:53.998559744Z`
...
```console
nginx-module-perl-1.16.1-r1 description:
nginx Perl dynamic module

nginx-module-perl-1.16.1-r1 webpage:
http://nginx.org/

nginx-module-perl-1.16.1-r1 installed size:
155648

nginx-module-perl-1.16.1-r1 license:
2-clause BSD-like license
