...
-	[`bash:devel-20190712`](#bashdevel-20190712)
...
```console
$ docker pull bash@sha256:0b4a25af66f3b65477911f460239a7a8dd76b52d1371c19957502f7f1c3f5110
```
...
```console
$ docker pull bash@sha256:764c64c826487962439cf96ed22f51ef6a1d00a2a7c45abad2db2d9d83893024
```
...
### `bash:devel-20190712` - linux; amd64
...
### `bash:devel-20190712` - linux; arm variant v6
...
### `bash:devel-20190712` - linux; arm variant v7
...
### `bash:devel-20190712` - linux; arm64 variant v8
...
### `bash:devel-20190712` - linux; ppc64le
