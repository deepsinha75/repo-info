...
```console
$ docker pull adoptopenjdk@sha256:fdbcb21a62ca5732286b079011b77449f40156d60b2e1d914b9e5d43d3decd9d
```
...
### `adoptopenjdk:8-hotspot-windowsservercore` - windows version 10.0.14393.3204; amd64
...
### `adoptopenjdk:8-hotspot-windowsservercore` - windows version 10.0.17763.737; amd64
...
### `adoptopenjdk:8-hotspot-windowsservercore` - windows version 10.0.17134.1006; amd64
