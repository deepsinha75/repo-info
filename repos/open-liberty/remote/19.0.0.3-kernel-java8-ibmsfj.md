...
```console
$ docker pull open-liberty@sha256:20745f113586874b7094c44e408e9b749406a787acff5e887f681d9d41220478
```
...
```console
$ docker pull open-liberty@sha256:fcc457858922f144c266a7503a7107c2deb17cf1209d22566eda858f3df9fdc5
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **197.9 MB (197930077 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0d0a26da5860d0da2a1cf7b01ba057e6a3c66ffee6fa91cd30f9132022ff0383`
