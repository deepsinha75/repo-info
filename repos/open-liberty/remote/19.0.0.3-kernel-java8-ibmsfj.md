...
```console
$ docker pull open-liberty@sha256:fee96fec1f32e769eb96be2b3fffb1566249e76132495f494c75da46ea75d7f5
```
...
```console
$ docker pull open-liberty@sha256:9c044b91d120186e25a5294ee3415e3f699a936db4e4d40c5e2455de00c549ac
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **197.9 MB (197943624 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8cc13cd694386f47f0a094a875dfdb9111b6b74a22c97fc0f923c297a764098f`
