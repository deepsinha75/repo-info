...
```console
$ docker pull open-liberty@sha256:0a946698d5ccdaae6bb83cc08646fba183f01bb7cfdc619672a2ee3a792c27cc
```
...
```console
$ docker pull open-liberty@sha256:88ff709183ab9920abbbaf9bd9260e4eebb2329e1ce5b828e3faa38ccf7d5eb3
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **198.0 MB (198025499 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:785820a2709bbd7f7ed06198ab92d06141563ee23ec126a4692042f8be1c38f9`
