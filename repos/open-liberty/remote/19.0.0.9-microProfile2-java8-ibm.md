## `open-liberty:19.0.0.9-microProfile2-java8-ibm`

```console
$ docker pull open-liberty@sha256:216231fb356bf081f503cea4bc4bfefb321c81695e9ab0e1bd6468b82b8a306e
```
...
### `open-liberty:19.0.0.9-microProfile2-java8-ibm` - linux; amd64
...
### `open-liberty:19.0.0.9-microProfile2-java8-ibm` - linux; 386

```console
$ docker pull open-liberty@sha256:42d50e99462aef3cd980d72272ecc92d94082abb5b7a231e7fa3e977f1987918
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **295.3 MB (295315886 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c0fb572120b941b3fcc5b2606b7f814fb5a9ce54dcebe9d6cc41b6000077e254`
-	Entrypoint: `["\/opt\/ol\/helpers\/runtime\/docker-server.sh"]`
-	Default Command: `["\/opt\/ol\/wlp\/bin\/server","run","defaultServer"]`
...
-	Layers:
	...
	-	`sha256:f8158c55c1b4b16f01e15afaf2778703b5a8bdf10879907cec90085b6b7f252e`  
		...
		Size: 3.3 KB (3258 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b74c2d3007f9cf3260a079b2d35e08bbc7c7443d318cc8d718450eb214dc698c`  
		Last Modified: Fri, 18 Oct 2019 19:50:41 GMT  
		Size: 549.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `open-liberty:19.0.0.9-microProfile2-java8-ibm` - linux; ppc64le
...
### `open-liberty:19.0.0.9-microProfile2-java8-ibm` - linux; s390x

```console
$ docker pull open-liberty@sha256:030ff79cad8506ef187bccfae0b4b9927d0283c672fdaecd01d837f413f69717
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **302.1 MB (302055569 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b272fd26314e678da93104989a118f87037b8f976fb447c01ebbccd0fef5d027`
-	Entrypoint: `["\/opt\/ol\/helpers\/runtime\/docker-server.sh"]`
-	Default Command: `["\/opt\/ol\/wlp\/bin\/server","run","defaultServer"]`
...
-	Layers:
	...
	-	`sha256:9e1259e5d668e6ff0f86def7e28c2a87a7a9deb3454c49433fbbab1914b0690d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c2a8dbece379310a6209593298ca0fc3e5c3cbf909cf2b694bd5991cabe79f96`  
		Last Modified: Fri, 18 Oct 2019 19:20:21 GMT  
		Size: 547.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
