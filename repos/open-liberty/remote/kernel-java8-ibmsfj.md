...
```console
$ docker pull open-liberty@sha256:9899e5718654c94c0ca5a0deafb61175652a65640686c00ffd2175507d3b5123
```
...
```console
$ docker pull open-liberty@sha256:cafb04c074d16ca5ebaca2805bd433542550754e69f8ae9705be0c42d538e7ef
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **216.4 MB (216419449 bytes)**  
