...
```console
$ docker pull open-liberty@sha256:ad32a5de498be7a5904a17544e4e9b6a8c44c3011a4bf86b5797b43823fb7020
```
...
```console
$ docker pull open-liberty@sha256:afd4e5f8d24c6237900de842c6cfb768f63b39ac9e79b650f7c8c00f7b542fe1
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **215.9 MB (215877987 bytes)**  
