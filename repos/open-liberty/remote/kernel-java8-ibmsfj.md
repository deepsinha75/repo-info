...
```console
$ docker pull open-liberty@sha256:2b319f6c6cd15642538a87ced75770e64c998664a06cd36e7c38a3e65e029258
```
...
```console
$ docker pull open-liberty@sha256:b043445f0a24151967cb1922397555968608f3a588ab22a1693d9694e379366b
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **200.7 MB (200747772 bytes)**  
