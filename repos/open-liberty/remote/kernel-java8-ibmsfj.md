...
```console
$ docker pull open-liberty@sha256:3a17ab015c61db901f0e80c0a7923fcdc82798554ba68e794f2d065335363b62
```
...
```console
$ docker pull open-liberty@sha256:a1ec2d594e805c4b86fc23b941c8cac93cff9311994b458bc70c9bcdba137687
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **218.5 MB (218523564 bytes)**  
