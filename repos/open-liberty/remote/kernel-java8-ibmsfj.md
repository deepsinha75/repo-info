...
```console
$ docker pull open-liberty@sha256:995d0677a1b9b2047d6618a445a7a493928d407f81a2f4249d61147768e5c10b
```
...
```console
$ docker pull open-liberty@sha256:6026a3b052c16be3030be16deab6642cf4e81dbd026e414d0b1676acdadfa24c
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **216.8 MB (216773278 bytes)**  
