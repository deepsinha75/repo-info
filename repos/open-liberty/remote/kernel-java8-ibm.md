...
```console
$ docker pull open-liberty@sha256:04765100ad7530696982111a5d98d4f15597e7fbc33b169e5455ce8742a926b7
```
...
```console
$ docker pull open-liberty@sha256:1a500852782b07684051d6fb0af1f25a44ac91b5f8205527ecf59fce482d0174
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **322.6 MB (322645722 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:53754227bf2653bf698115581e26cc080b8eb0ed96ced99705e7bf7476437697`
-	Entrypoint: `["\/opt\/ol\/helpers\/runtime\/docker-server.sh"]`
-	Default Command: `["\/opt\/ol\/wlp\/bin\/server","run","defaultServer"]`
