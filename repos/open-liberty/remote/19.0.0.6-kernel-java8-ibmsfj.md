...
```console
$ docker pull open-liberty@sha256:985bf1c0b4457e9a2cbde41e79125f5eacc6aeead501449ff081d8949fcda384
```
...
```console
$ docker pull open-liberty@sha256:e4e34ab202caa474928298a5e4ae4d321dc2fb091b4b71659ce7586a4e23af1f
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **200.2 MB (200190510 bytes)**  
