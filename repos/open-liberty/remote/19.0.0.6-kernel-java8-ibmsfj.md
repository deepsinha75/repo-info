...
```console
$ docker pull open-liberty@sha256:fc98bceece4890a0374b6e7c17f5452d9838603983a55cea68c7b0c2e622ce5e
```
...
```console
$ docker pull open-liberty@sha256:11c71b9d92e680646d6567e86048fe213431ee58f019b953735b4457a0d9b693
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **200.2 MB (200184649 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ccb71ff97ce33705e6457319add11cad86c7e72fce4cd90f4c24f7a6acdb7896`
