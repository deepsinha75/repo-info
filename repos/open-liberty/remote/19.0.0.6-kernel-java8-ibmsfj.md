## `open-liberty:19.0.0.6-kernel-java8-ibmsfj`

```console
$ docker pull open-liberty@sha256:08432095a9de9edb2a3abb7d963f9232f1413ab005eb86dec571bb63125baf51
```
...
### `open-liberty:19.0.0.6-kernel-java8-ibmsfj` - linux; amd64

```console
$ docker pull open-liberty@sha256:df6692b96c4c2cf83c42b7e38925599e561871488bc0b1b80bc484e28c358e29
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **200.2 MB (200185039 bytes)**  
