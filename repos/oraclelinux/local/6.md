...
- Created: `2019-07-15T23:28:56.800015925Z`
...
https://yum.oracle.com/repo/OracleLinux/OL6/latest/x86_64//getPackageSource/binutils-2.20.51.0.2-5.48.el6_10.1.src.rpm
```
...
### `rpm` package: `libgudev1-147-2.73.0.2.el6_8.2.x86_64`
...
```console
$ yumdownloader --quiet --source --urls libgudev1-147-2.73.0.2.el6_8.2
https://yum.oracle.com/repo/OracleLinux/OL6/latest/x86_64//getPackageSource/udev-147-2.73.0.2.el6_8.2.src.rpm
```
...
### `rpm` package: `libudev-147-2.73.0.2.el6_8.2.x86_64`
...
```console
$ yumdownloader --quiet --source --urls libudev-147-2.73.0.2.el6_8.2
https://yum.oracle.com/repo/OracleLinux/OL6/latest/x86_64//getPackageSource/udev-147-2.73.0.2.el6_8.2.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL6/latest/x86_64//getPackageSource/tzdata-2019b-2.el6.src.rpm
```

### `rpm` package: `udev-147-2.73.0.2.el6_8.2.x86_64`
...
```console
$ yumdownloader --quiet --source --urls udev-147-2.73.0.2.el6_8.2
https://yum.oracle.com/repo/OracleLinux/OL6/latest/x86_64//getPackageSource/udev-147-2.73.0.2.el6_8.2.src.rpm
```

### `rpm` package: `upstart-0.6.5-17.el6.x86_64`
...
```console
$ yumdownloader --quiet --source --urls upstart-0.6.5-17.el6
https://yum.oracle.com/repo/OracleLinux/OL6/latest/x86_64//getPackageSource/upstart-0.6.5-17.el6.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL6/latest/x86_64//getPackageSource/vim-7.4.629-5.el6_8.1.src.rpm
```
