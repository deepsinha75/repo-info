...
- Created: `2019-08-14T06:56:20.9496799Z`
- Virtual Size: ~ 220.62 Mb  
  (total size of all layers on-disk)
- Arch: `linux`/`amd64`
- Command: `["bash"]`
- Environment:
  - `PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin`
  - `MONO_VERSION=5.18.1.28`
...
### `dpkg` source package: `mono=5.18.1.28-0xamarin5+debian9b1`

Binary Packages:

- `ca-certificates-mono=5.18.1.28-0xamarin5+debian9b1`
- `libmono-btls-interface4.0-cil=5.18.1.28-0xamarin5+debian9b1`
- `libmono-corlib4.5-cil=5.18.1.28-0xamarin5+debian9b1`
- `libmono-i18n-west4.0-cil=5.18.1.28-0xamarin5+debian9b1`
- `libmono-i18n4.0-cil=5.18.1.28-0xamarin5+debian9b1`
- `libmono-security4.0-cil=5.18.1.28-0xamarin5+debian9b1`
- `libmono-system-configuration4.0-cil=5.18.1.28-0xamarin5+debian9b1`
- `libmono-system-core4.0-cil=5.18.1.28-0xamarin5+debian9b1`
- `libmono-system-numerics4.0-cil=5.18.1.28-0xamarin5+debian9b1`
- `libmono-system-security4.0-cil=5.18.1.28-0xamarin5+debian9b1`
- `libmono-system-xml4.0-cil=5.18.1.28-0xamarin5+debian9b1`
- `libmono-system4.0-cil=5.18.1.28-0xamarin5+debian9b1`
- `mono-4.0-gac=5.18.1.28-0xamarin5+debian9b1`
- `mono-gac=5.18.1.28-0xamarin5+debian9b1`
- `mono-llvm-support=5.18.1.28-0xamarin5+debian9b1`
- `mono-runtime=5.18.1.28-0xamarin5+debian9b1`
- `mono-runtime-common=5.18.1.28-0xamarin5+debian9b1`
- `mono-runtime-sgen=5.18.1.28-0xamarin5+debian9b1`
...
```console
$ apt-get source -qq --print-uris mono=5.18.1.28-0xamarin5+debian9b1
'http://download.mono-project.com/repo/debian/pool/main/m/mono/mono_5.18.1.28-0xamarin5+debian9b1.dsc' mono_5.18.1.28-0xamarin5+debian9b1.dsc 19112 SHA256:0e0faf018600e328e871574b3d9cd4122b55a126e8d2bb15d0107cc18f49047c
'http://download.mono-project.com/repo/debian/pool/main/m/mono/mono_5.18.1.28.orig.tar.bz2' mono_5.18.1.28.orig.tar.bz2 286666158 SHA256:3e0368a85ebd2c6f75b0ad928a81b6530b5a4299ff191389d3dd0bf893d12d31
'http://download.mono-project.com/repo/debian/pool/main/m/mono/mono_5.18.1.28-0xamarin5+debian9b1.debian.tar.xz' mono_5.18.1.28-0xamarin5+debian9b1.debian.tar.xz 152544 SHA256:a5f91f3075e4ba5ba4fd0a9f2d59807894bcc862a78c832bd9ea56004776d10a
```
