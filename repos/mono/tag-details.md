...
```console
$ docker pull mono@sha256:a9c2f365710e5b51106ac96da8d90586fcdad8fdd148590f4c76070eb110fcbc
```
...
```console
$ docker pull mono@sha256:1a48913390601aca48507269d6c5ce7d70d4abedaa01cd331916cef6b05fe1e0
```
